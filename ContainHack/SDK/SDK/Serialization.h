...
{ 
	...
	SDK_UNDEFINED(48,2536) /* TWeakObjectPtr<UClass*> */ __um(SoftClass);                                          // 0x0018   (0x0030)  
	class UObject*                                     RawObject;                                                  // 0x0048   (0x0008)  
	class UObject*                                     WrappedObject;                                              // 0x0050   (0x0008)  
	SDK_UNDEFINED(8,2537) /* TWeakObjectPtr<UMetaData*> */ __um(WeakObject);                                       // 0x0058   (0x0008)  
	SDK_UNDEFINED(48,2538) /* TWeakObjectPtr<UMetaData*> */ __um(SoftObject);                                      // 0x0060   (0x0030)  
...
{ 
	...
	SDK_UNDEFINED(16,2539) /* FString */               __um(String);                                               // 0x0018   (0x0010)  
	SDK_UNDEFINED(24,2540) /* FText */                 __um(Text);                                                 // 0x0028   (0x0018)  
...
{ 
	...
	SDK_UNDEFINED(80,2541) /* TMap<FString, FVector> */ __um(StrToVec);                                            // 0x02C0   (0x0050)  
	SDK_UNDEFINED(80,2542) /* TSet<FVector> */         __um(VectorSet);                                            // 0x0310   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(80,2543) /* TMap<FString, FVector3f> */ __um(StrToVec);                                          // 0x0178   (0x0050)  
	SDK_UNDEFINED(80,2544) /* TSet<FVector3f> */       __um(VectorSet);                                            // 0x01C8   (0x0050)  
...
{ 
	SDK_UNDEFINED(80,2545) /* TMap<int32_t, FString> */ __um(IntToStr);                                            // 0x0000   (0x0050)  
	SDK_UNDEFINED(80,2546) /* TMap<FString, FString> */ __um(StrToStr);                                            // 0x0050   (0x0050)  
	SDK_UNDEFINED(80,2547) /* TMap<FString, FVector> */ __um(StrToVec);                                            // 0x00A0   (0x0050)  
	SDK_UNDEFINED(80,2548) /* TMap<FString, FStructSerializerBuiltinTestStruct> */ __um(StrToStruct);              // 0x00F0   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(80,2549) /* TSet<FString> */         __um(StrSet);                                               // 0x0000   (0x0050)  
	SDK_UNDEFINED(80,2550) /* TSet<int32_t> */         __um(IntSet);                                               // 0x0050   (0x0050)  
	SDK_UNDEFINED(80,2551) /* TSet<FName> */           __um(NameSet);                                              // 0x00A0   (0x0050)  
	SDK_UNDEFINED(80,2552) /* TSet<FStructSerializerBuiltinTestStruct> */ __um(StructSet);                         // 0x00F0   (0x0050)  
};

/// Struct /Script/Serialization.StructSerializerTestStruct
/// Size: 0x0820 (0x000000 - 0x000820)
