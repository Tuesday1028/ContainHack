...
{ 
public:
	SDK_UNDEFINED(80,2163) /* TSet<FName> */           __um(Layers);                                               // 0x0030   (0x0050)  
	SDK_UNDEFINED(80,2164) /* TSet<FName> */           __um(Tags);                                                 // 0x0080   (0x0050)  
};
...
{ 
public:
	SDK_UNDEFINED(1,2165) /* TEnumAsByte<EComponentMobility> */ __um(Mobility);                                    // 0x0290   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(48,2166) /* TWeakObjectPtr<UTextureLightProfile*> */ __um(IESTexture);                           // 0x0068   (0x0030)  
...
{ 
public:
	SDK_UNDEFINED(16,2167) /* FString */               __um(Generator);                                            // 0x0028   (0x0010)  
	float                                              Version;                                                    // 0x0038   (0x0004)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x003C   (0x0004)  MISSED
	SDK_UNDEFINED(16,2168) /* FString */               __um(Author);                                               // 0x0040   (0x0010)  
	SDK_UNDEFINED(16,2169) /* FString */               __um(License);                                              // 0x0050   (0x0010)  
	SDK_UNDEFINED(16,2170) /* FString */               __um(Source);                                               // 0x0060   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(16,2171) /* FString */               __um(SourceMeshName);                                       // 0x0028   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(16,2172) /* FString */               __um(TexturesDir);                                          // 0x0030   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,2173) /* FString */               __um(VarPath);                                              // 0x0050   (0x0010)  
	bool                                               bImportPos;                                                 // 0x0060   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0061   (0x0007)  MISSED
	SDK_UNDEFINED(16,2174) /* FString */               __um(PosPath);                                              // 0x0068   (0x0010)  
	bool                                               bImportTml;                                                 // 0x0078   (0x0001)  
	unsigned char                                      UnknownData02_5[0x7];                                       // 0x0079   (0x0007)  MISSED
	SDK_UNDEFINED(16,2175) /* FString */               __um(TmlPath);                                              // 0x0080   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(16,2176) /* FString */               __um(MatsPath);                                             // 0x0050   (0x0010)  
	bool                                               bImportVar;                                                 // 0x0060   (0x0001)  
	bool                                               bCleanVar;                                                  // 0x0061   (0x0001)  
	unsigned char                                      UnknownData01_5[0x6];                                       // 0x0062   (0x0006)  MISSED
	SDK_UNDEFINED(16,2177) /* FString */               __um(VarPath);                                              // 0x0068   (0x0010)  
	bool                                               bImportLightInfo;                                           // 0x0078   (0x0001)  
	unsigned char                                      UnknownData02_5[0x7];                                       // 0x0079   (0x0007)  MISSED
	SDK_UNDEFINED(16,2178) /* FString */               __um(LightInfoPath);                                        // 0x0080   (0x0010)  
	bool                                               bImportClipInfo;                                            // 0x0090   (0x0001)  
	unsigned char                                      UnknownData03_5[0x7];                                       // 0x0091   (0x0007)  MISSED
	SDK_UNDEFINED(16,2179) /* FString */               __um(ClipInfoPath);                                         // 0x0098   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(16,2180) /* FString */               __um(SourceGlobalId);                                       // 0x0028   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(80,2181) /* TMap<FName, FString> */  __um(MetaData);                                             // 0x0028   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(48,2182) /* TWeakObjectPtr<AActor*> */ __um(ActorToTrack);                                       // 0x0008   (0x0030)  
};
...
{ 
	...
	SDK_UNDEFINED(1,2183) /* TEnumAsByte<EAutoExposureMethod> */ __um(AutoExposureMethod);                         // 0x0030   (0x0001)  
...
public:
	...
	// TArray<FString> GetDatasmithUserDataValuesForKey(class UObject* Object, FName Key, bool bPartialMatchKey);            // [0x1c10ea0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataValueForKey
	// FString GetDatasmithUserDataValueForKey(class UObject* Object, FName Key, bool bPartialMatchKey);                     // [0x1c10d50] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataKeysAndValuesForValue
	// void GetDatasmithUserDataKeysAndValuesForValue(class UObject* Object, FString StringToMatch, TArray<FName>& OutKeys, TArray<FString>& OutValues); // [0x1c10b80] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserData
	// class UDatasmithAssetUserData* GetDatasmithUserData(class UObject* Object);                                           // [0x1c10af0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void PlayLevelSequence(class ULevelSequence* SequenceToPlay);                                                         // [0x1c11040] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(16,2184) /* FString */               __um(Filename);                                             // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,2185) /* FString */               __um(FilePath);                                             // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,2186) /* FString */               __um(SourceUri);                                            // 0x0068   (0x0010)  
...
{ 
	SDK_UNDEFINED(80,2187) /* TMap<FName, bool> */     __um(StaticSwitchParameters);                               // 0x0000   (0x0050)  
};
...
{ 
public:
	SDK_UNDEFINED(48,2188) /* TWeakObjectPtr<UMaterialInterface*> */ __um(ParentMaterial);                         // 0x0030   (0x0030)  
	SDK_UNDEFINED(80,2189) /* TMap<FName, float> */    __um(ScalarParameterValues);                                // 0x0060   (0x0050)  
	SDK_UNDEFINED(80,2190) /* TMap<FName, FLinearColor> */ __um(VectorParameterValues);                            // 0x00B0   (0x0050)  
	SDK_UNDEFINED(80,2191) /* TMap<FName, TWeakObjectPtr<UTexture*>> */ __um(TextureParameterValues);              // 0x0100   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,2192) /* TMap<FName, TWeakObjectPtr<AActor*>> */ __um(RelatedActors);                         // 0x0298   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(1,2193) /* TEnumAsByte<EComponentMobility> */ __um(Mobility);                                    // 0x0090   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0091   (0x0007)  MISSED
	SDK_UNDEFINED(48,2194) /* TWeakObjectPtr<USceneComponent*> */ __um(AttachParent);                              // 0x0098   (0x0030)  
	bool                                               bVisible;                                                   // 0x00C8   (0x0001)  
	bool                                               bCastShadow;                                                // 0x00C9   (0x0001)  
	unsigned char                                      UnknownData01_5[0x6];                                       // 0x00CA   (0x0006)  MISSED
	SDK_UNDEFINED(80,2195) /* TSet<FName> */           __um(Tags);                                                 // 0x00D0   (0x0050)  
};
...
{ 
public:
	SDK_UNDEFINED(1,2196) /* TEnumAsByte<ESkyLightSourceType> */ __um(SourceType);                                 // 0x0030   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x0031   (0x0003)  MISSED
...
{ 
	SDK_UNDEFINED(80,2197) /* TMap<uint32_t, FDatasmithMeshSectionInfoTemplate> */ __um(Map);                      // 0x0000   (0x0050)  
};
