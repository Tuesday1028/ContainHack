...
{ 
public:
	SDK_UNDEFINED(80,31) /* TMap<UClass*, FPlatformSettingsInstances> */ __um(SettingsMap);                        // 0x0028   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(80,32) /* TMap<FName, UPlatformSettings*> */ __um(OtherPlatforms);                               // 0x0008   (0x0050)  
};
