...
{ 
public:
	SDK_UNDEFINED(16,2322) /* FMulticastInlineDelegate */ __um(OnInstanceTakePointDamage);                         // 0x08C8   (0x0010)  
	SDK_UNDEFINED(16,2323) /* FMulticastInlineDelegate */ __um(OnInstanceTakeRadialDamage);                        // 0x08D8   (0x0010)  
	bool                                               bEnableDiscardOnLoad;                                       // 0x08E8   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x08E9   (0x0003)  MISSED
	FGuid                                              GenerationGuid;                                             // 0x08EC   (0x0010)  
	unsigned char                                      UnknownData01_6[0x4];                                       // 0x08FC   (0x0004)  MISSED
};
...
public:
	...
	SDK_UNDEFINED(1,2324) /* TEnumAsByte<FoliageVertexColorMask> */ __um(VertexColorMask);                         // 0x0098   (0x0001)  
	...
	SDK_UNDEFINED(1,2325) /* TEnumAsByte<EComponentMobility> */ __um(Mobility);                                    // 0x0178   (0x0001)  
	...
	SDK_UNDEFINED(1,2326) /* TEnumAsByte<EHasCustomNavigableGeometry> */ __um(CustomNavigableGeometry);            // 0x0338   (0x0001)  
...
{ 
public:
	unsigned char                                      UnknownData00_1[0x10];                                      // 0x05F0   (0x0010)  MISSED
};
...
public:
	...
	// int32_t FoliageOverlappingSphereCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FVector CenterPosition, float Radius); // [0x32b6040] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Foliage.FoliageStatistics.FoliageOverlappingBoxTransforms
	// void FoliageOverlappingBoxTransforms(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FBox Box, TArray<FTransform>& OutTransforms); // [0x32b5eb0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/Foliage.FoliageStatistics.FoliageOverlappingBoxCount
	// int32_t FoliageOverlappingBoxCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FBox Box);       // [0x32b5d50] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};

/// Class /Script/Foliage.GrassInstancedStaticMeshComponent
/// Size: 0x0000 (0x0008D0 - 0x0008D0)
...
public:
	...
	// void CapsuleTouched(class UPrimitiveComponent* OverlappedComp, class AActor* Other, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& OverlapInfo); // [0x32b5990] Final|Native|Protected|HasOutParms 
};
...
public:
	...
	// void Simulate(int32_t NumSteps);                                                                                      // [0x32b61c0] Final|Native|Public|BlueprintCallable 
};
