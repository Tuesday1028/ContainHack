...
{ 
	...
	SDK_UNDEFINED(80,2044) /* TMap<uint32_t, FPointWeightMap> */ __um(WeightMaps);                                 // 0x0030   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,2045) /* TMap<FName, UClothConfigBase*> */ __um(ClothConfigs);                                // 0x0050   (0x0050)  
