...
{ 
	SDK_UNDEFINED(16,2302) /* FString */               __um(Command);                                              // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2303) /* FString */               __um(Desc);                                                 // 0x0010   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,2304) /* TArray<FString> */       __um(AutoCompleteMapPaths);                                 // 0x0040   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2305) /* FString */               __um(Name);                                                 // 0x0000   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,2306) /* FString */               __um(LocalMapOptions);                                      // 0x0028   (0x0010)  
	FSoftObjectPath                                    TransitionMap;                                              // 0x0038   (0x0020)  
	bool                                               bUseSplitscreen;                                            // 0x0058   (0x0001)  
	SDK_UNDEFINED(1,2307) /* TEnumAsByte<ETwoPlayerSplitScreenType> */ __um(TwoPlayerSplitscreenLayout);           // 0x0059   (0x0001)  
	SDK_UNDEFINED(1,2308) /* TEnumAsByte<EThreePlayerSplitScreenType> */ __um(ThreePlayerSplitscreenLayout);       // 0x005A   (0x0001)  
	...
	// void SetSkipAssigningGamepadToPlayer1(bool bSkipFirstPlayer);                                                         // [0x2c69b90] Final|Native|Public|BlueprintCallable 
	// Function /Script/EngineSettings.GameMapsSettings.GetSkipAssigningGamepadToPlayer1
	// bool GetSkipAssigningGamepadToPlayer1();                                                                              // [0x2c69b60] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EngineSettings.GameMapsSettings.GetGameMapsSettings
	// class UGameMapsSettings* GetGameMapsSettings();                                                                       // [0x2c69b30] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
{ 
public:
	SDK_UNDEFINED(16,2309) /* FString */               __um(CompanyName);                                          // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,2310) /* FString */               __um(CompanyDistinguishedName);                             // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,2311) /* FString */               __um(CopyrightNotice);                                      // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,2312) /* FString */               __um(Description);                                          // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,2313) /* FString */               __um(Homepage);                                             // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,2314) /* FString */               __um(LicensingTerms);                                       // 0x0078   (0x0010)  
	SDK_UNDEFINED(16,2315) /* FString */               __um(PrivacyPolicy);                                        // 0x0088   (0x0010)  
	FGuid                                              ProjectID;                                                  // 0x0098   (0x0010)  
	SDK_UNDEFINED(16,2316) /* FString */               __um(ProjectName);                                          // 0x00A8   (0x0010)  
	SDK_UNDEFINED(16,2317) /* FString */               __um(ProjectVersion);                                       // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,2318) /* FString */               __um(SupportContact);                                       // 0x00C8   (0x0010)  
	SDK_UNDEFINED(24,2319) /* FText */                 __um(ProjectDisplayedTitle);                                // 0x00D8   (0x0018)  
	SDK_UNDEFINED(24,2320) /* FText */                 __um(ProjectDebugTitleInfo);                                // 0x00F0   (0x0018)  
...
{ 
	...
	SDK_UNDEFINED(24,2321) /* FText */                 __um(DisplayName);                                          // 0x0040   (0x0018)  
};
