...
public:
	...
	SDK_UNDEFINED(16,33) /* FString */                 __um(PerObjectConfigSection);                               // 0x0050   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,34) /* TArray<FString> */         __um(EscalationSeverity);                                   // 0x0068   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,35) /* FString */                 __um(StateName);                                            // 0x0008   (0x0010)  
};
