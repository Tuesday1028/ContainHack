...
{ 
	SDK_UNDEFINED(16,2017) /* FString */               __um(Filename);                                             // 0x0000   (0x0010)  
	FSHAHashData                                       FileHash;                                                   // 0x0010   (0x0014)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x0024   (0x0004)  MISSED
	TArray<FChunkPartData>                             FileChunkParts;                                             // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,2018) /* TArray<FString> */       __um(InstallTags);                                          // 0x0038   (0x0010)  
	bool                                               bIsUnixExecutable;                                          // 0x0048   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0049   (0x0007)  MISSED
	SDK_UNDEFINED(16,2019) /* FString */               __um(SymlinkTarget);                                        // 0x0050   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2020) /* FString */               __um(Key);                                                  // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2021) /* FString */               __um(Value);                                                // 0x0010   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(16,2022) /* FString */               __um(AppName);                                              // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,2023) /* FString */               __um(BuildVersion);                                         // 0x0040   (0x0010)  
	SDK_UNDEFINED(16,2024) /* FString */               __um(LaunchExe);                                            // 0x0050   (0x0010)  
	SDK_UNDEFINED(16,2025) /* FString */               __um(LaunchCommand);                                        // 0x0060   (0x0010)  
	SDK_UNDEFINED(80,2026) /* TSet<FString> */         __um(PrereqIds);                                            // 0x0070   (0x0050)  
	SDK_UNDEFINED(16,2027) /* FString */               __um(PrereqName);                                           // 0x00C0   (0x0010)  
	SDK_UNDEFINED(16,2028) /* FString */               __um(PrereqPath);                                           // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,2029) /* FString */               __um(PrereqArgs);                                           // 0x00E0   (0x0010)  
