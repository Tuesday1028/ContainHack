...
public:
	...
	SDK_UNDEFINED(16,1943) /* FMulticastInlineDelegate */ __um(OnSpectrumResults);                                 // 0x0098   (0x0010)  
	unsigned char                                      UnknownData00_5[0x18];                                      // 0x00A8   (0x0018)  MISSED
	SDK_UNDEFINED(16,1944) /* FMulticastInlineDelegate */ __um(OnLatestSpectrumResults);                           // 0x00C0   (0x0010)  
	...
	// int32_t GetNumCenterFrequencies();                                                                                    // [0x1531e50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioSynesthesia.SynesthesiaSpectrumAnalyzer.GetCenterFrequencies
	// void GetCenterFrequencies(float InSampleRate, TArray<float>& OutCenterFrequencies);                                   // [0x1531080] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void GetNormalizedChannelConstantQAtTime(float InSeconds, int32_t InChannel, TArray<float>& OutConstantQ);            // [0x1531810] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioSynesthesia.ConstantQNRT.GetChannelConstantQAtTime
	// void GetChannelConstantQAtTime(float InSeconds, int32_t InChannel, TArray<float>& OutConstantQ);                      // [0x1531180] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	SDK_UNDEFINED(16,1945) /* FMulticastInlineDelegate */ __um(OnOverallLoudnessResults);                          // 0x0098   (0x0010)  
	SDK_UNDEFINED(16,1946) /* FMulticastInlineDelegate */ __um(OnPerChannelLoudnessResults);                       // 0x00A8   (0x0010)  
	SDK_UNDEFINED(16,1947) /* FMulticastInlineDelegate */ __um(OnLatestOverallLoudnessResults);                    // 0x00B8   (0x0010)  
	SDK_UNDEFINED(16,1948) /* FMulticastInlineDelegate */ __um(OnLatestPerChannelLoudnessResults);                 // 0x00C8   (0x0010)  
};
...
public:
	...
	// void GetNormalizedLoudnessAtTime(float InSeconds, float& OutLoudness);                                                // [0x1531d60] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioSynesthesia.LoudnessNRT.GetNormalizedChannelLoudnessAtTime
	// void GetNormalizedChannelLoudnessAtTime(float InSeconds, int32_t InChannel, float& OutLoudness);                      // [0x1531950] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioSynesthesia.LoudnessNRT.GetLoudnessAtTime
	// void GetLoudnessAtTime(float InSeconds, float& OutLoudness);                                                          // [0x1531720] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioSynesthesia.LoudnessNRT.GetChannelLoudnessAtTime
	// void GetChannelLoudnessAtTime(float InSeconds, int32_t InChannel, float& OutLoudness);                                // [0x1531360] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	SDK_UNDEFINED(16,1949) /* FMulticastInlineDelegate */ __um(OnOverallMeterResults);                             // 0x0098   (0x0010)  
	unsigned char                                      UnknownData00_5[0x18];                                      // 0x00A8   (0x0018)  MISSED
	SDK_UNDEFINED(16,1950) /* FMulticastInlineDelegate */ __um(OnPerChannelMeterResults);                          // 0x00C0   (0x0010)  
	unsigned char                                      UnknownData01_5[0x18];                                      // 0x00D0   (0x0018)  MISSED
	SDK_UNDEFINED(16,1951) /* FMulticastInlineDelegate */ __um(OnLatestOverallMeterResults);                       // 0x00E8   (0x0010)  
	unsigned char                                      UnknownData02_5[0x18];                                      // 0x00F8   (0x0018)  MISSED
	SDK_UNDEFINED(16,1952) /* FMulticastInlineDelegate */ __um(OnLatestPerChannelMeterResults);                    // 0x0110   (0x0010)  
...
public:
	...
	// void GetNormalizedChannelOnsetsBetweenTimes(float InStartSeconds, float InEndSeconds, int32_t InChannel, TArray<float>& OutOnsetTimestamps, TArray<float>& OutOnsetStrengths); // [0x1531a70] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioSynesthesia.OnsetNRT.GetChannelOnsetsBetweenTimes
	// void GetChannelOnsetsBetweenTimes(float InStartSeconds, float InEndSeconds, int32_t InChannel, TArray<float>& OutOnsetTimestamps, TArray<float>& OutOnsetStrengths); // [0x1531480] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
