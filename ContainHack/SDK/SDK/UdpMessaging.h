...
public:
	...
	SDK_UNDEFINED(16,2805) /* FString */               __um(UnicastEndpoint);                                      // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,2806) /* FString */               __um(MulticastEndpoint);                                    // 0x0048   (0x0010)  
	...
	SDK_UNDEFINED(16,2807) /* TArray<FString> */       __um(StaticEndpoints);                                      // 0x0060   (0x0010)  
	SDK_UNDEFINED(16,2808) /* TArray<FString> */       __um(ExcludedEndpoints);                                    // 0x0070   (0x0010)  
	bool                                               EnableTunnel;                                               // 0x0080   (0x0001)  
	unsigned char                                      UnknownData03_5[0x7];                                       // 0x0081   (0x0007)  MISSED
	SDK_UNDEFINED(16,2809) /* FString */               __um(TunnelUnicastEndpoint);                                // 0x0088   (0x0010)  
	SDK_UNDEFINED(16,2810) /* FString */               __um(TunnelMulticastEndpoint);                              // 0x0098   (0x0010)  
	SDK_UNDEFINED(16,2811) /* TArray<FString> */       __um(RemoteTunnelEndpoints);                                // 0x00A8   (0x0010)  
};
