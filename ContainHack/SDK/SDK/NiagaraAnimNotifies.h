...
public:
	...
	// class UFXSystemComponent* GetSpawnedEffect(class UMeshComponent* MeshComp);                                           // [0x100c790] Final|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// float GetNotifyProgress(class UMeshComponent* MeshComp);                                                              // [0x100c6f0] Final|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// class UFXSystemComponent* GetSpawnedEffect();                                                                         // [0xc65270] Final|Native|Public|BlueprintCallable|Const 
};
