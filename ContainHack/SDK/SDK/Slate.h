...
{ 
public:
	FScrollBoxStyle                                    ScrollBoxStyle;                                             // 0x0030   (0x0350)  
};
...
{ 
	...
	SDK_UNDEFINED(80,55) /* TMap<FName, FCustomizedToolMenuEntry> */ __um(Entries);                                // 0x0008   (0x0050)  
	SDK_UNDEFINED(80,56) /* TMap<FName, FCustomizedToolMenuSection> */ __um(Sections);                             // 0x0058   (0x0050)  
	SDK_UNDEFINED(80,57) /* TMap<FName, FCustomizedToolMenuNameArray> */ __um(EntryOrder);                         // 0x00A8   (0x0050)  
