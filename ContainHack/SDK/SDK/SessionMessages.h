...
{ 
	SDK_UNDEFINED(16,2553) /* FString */               __um(username);                                             // 0x0000   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(16,2554) /* FString */               __um(BuildDate);                                            // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,2555) /* FString */               __um(DeviceName);                                           // 0x0018   (0x0010)  
	FGuid                                              InstanceId;                                                 // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,2556) /* FString */               __um(InstanceName);                                         // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,2557) /* FString */               __um(PlatformName);                                         // 0x0048   (0x0010)  
	FGuid                                              SessionID;                                                  // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,2558) /* FString */               __um(SessionName);                                          // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,2559) /* FString */               __um(SessionOwner);                                         // 0x0078   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,2560) /* FString */               __um(Data);                                                 // 0x0008   (0x0010)  
