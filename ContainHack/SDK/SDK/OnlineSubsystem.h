...
{ 
	FName                                              InterfaceName;                                              // 0x0000   (0x0008)  
	SDK_UNDEFINED(16,2532) /* FString */               __um(InterfaceClassName);                                   // 0x0008   (0x0010)  
};
...
public:
	...
	// void OnMatchReceivedTurn(FString Match, bool bDidBecomeActive);                                                       // [0x2119480] Event|Public|BlueprintEvent 
	// Function /Script/OnlineSubsystem.TurnBasedMatchInterface.OnMatchEnded
	// void OnMatchEnded(FString Match);                                                                                     // [0x2119480] Event|Public|BlueprintEvent 
};
