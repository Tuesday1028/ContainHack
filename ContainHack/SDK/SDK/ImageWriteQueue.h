...
public:
	...
	// void ExportToDisk(class UTexture* Texture, FString Filename, FImageWriteOptions& Options);                            // [0x256d4c0] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
{ 
	...
	SDK_UNDEFINED(16,2483) /* FDelegateProperty */     __um(OnComplete);                                           // 0x0004   (0x0010)  
