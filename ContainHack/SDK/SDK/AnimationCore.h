...
{ 
public:
	SDK_UNDEFINED(80,1121) /* TMap<FName, TWeakObjectPtr<UObject*>> */ __um(DataSources);                          // 0x0028   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(80,1122) /* TMap<FName, int32_t> */  __um(NodeNameToIndexMapping);                               // 0x0020   (0x0050)  
};
