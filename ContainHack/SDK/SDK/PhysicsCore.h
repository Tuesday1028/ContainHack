...
public:
	...
	SDK_UNDEFINED(1,37) /* TEnumAsByte<EPhysicsType> */ __um(PhysicsType);                                         // 0x0030   (0x0001)  
	SDK_UNDEFINED(1,38) /* TEnumAsByte<ECollisionTraceFlag> */ __um(CollisionTraceFlag);                           // 0x0031   (0x0001)  
	SDK_UNDEFINED(1,39) /* TEnumAsByte<EBodyCollisionResponse> */ __um(CollisionReponse);                          // 0x0032   (0x0001)  
...
public:
	float                                              Friction;                                                   // 0x0028   (0x0004)  
	float                                              StaticFriction;                                             // 0x002C   (0x0004)  
	SDK_UNDEFINED(1,40) /* TEnumAsByte<EFrictionCombineMode> */ __um(FrictionCombineMode);                         // 0x0030   (0x0001)  
	...
	SDK_UNDEFINED(1,41) /* TEnumAsByte<EFrictionCombineMode> */ __um(RestitutionCombineMode);                      // 0x0038   (0x0001)  
	...
	SDK_UNDEFINED(1,42) /* TEnumAsByte<EPhysicalSurface> */ __um(SurfaceType);                                     // 0x0060   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(1,43) /* TEnumAsByte<EFrictionCombineMode> */ __um(FrictionCombineMode);                         // 0x005C   (0x0001)  
	SDK_UNDEFINED(1,44) /* TEnumAsByte<EFrictionCombineMode> */ __um(RestitutionCombineMode);                      // 0x005D   (0x0001)  
	...
	SDK_UNDEFINED(1,45) /* TEnumAsByte<ECollisionTraceFlag> */ __um(DefaultShapeComplexity);                       // 0x0075   (0x0001)  
