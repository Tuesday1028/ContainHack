...
public:
	...
	// void ExecuteUbergraph(int32_t EntryPoint);                                                                            // [0x2119480] Event|Public|BlueprintEvent 
};
...
{ 
public:
	unsigned char                                      UnknownData00_1[0x1C0];                                     // 0x0230   (0x01C0)  MISSED
};
...
{ 
	...
	SDK_UNDEFINED(16,1) /* FString */                  __um(SubPathString);                                        // 0x0010   (0x0010)  
};
...
{ 
	...
	SDK_UNDEFINED(80,2) /* TSet<FName> */              __um(RecursiveClassesExclusionSet);                         // 0x00A0   (0x0050)  
	SDK_UNDEFINED(80,3) /* TSet<FTopLevelAssetPath> */ __um(RecursiveClassPathsExclusionSet);                      // 0x00F0   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(16,4) /* FString */                  __um(Message);                                              // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,5) /* FString */                  __um(Context);                                              // 0x0018   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(16,6) /* FString */                  __um(Filename);                                             // 0x0038   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,7) /* FString */                  __um(Path);                                                 // 0x0000   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(1,8) /* TEnumAsByte<ERangeBoundTypes> */ __um(Type);                                             // 0x0000   (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0001   (0x0007)  MISSED
...
struct FFilePath
{ 
	SDK_UNDEFINED(16,9) /* FString */                  __um(FilePath);                                             // 0x0000   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(1,10) /* TEnumAsByte<ERangeBoundTypes> */ __um(Type);                                            // 0x0000   (0x0001)  
...
{ 
	SDK_UNDEFINED(1,12) /* TEnumAsByte<ERangeBoundTypes> */ __um(Type);                                            // 0x0000   (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x0001   (0x0003)  MISSED
...
{ 
	...
	SDK_UNDEFINED(1,13) /* TEnumAsByte<EInterpCurveMode> */ __um(InterpMode);                                      // 0x0010   (0x0001)  
	unsigned char                                      UnknownData00_6[0x3];                                       // 0x0011   (0x0003)  MISSED
};
...
{ 
	...
	SDK_UNDEFINED(1,14) /* TEnumAsByte<EInterpCurveMode> */ __um(InterpMode);                                      // 0x0034   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(1,15) /* TEnumAsByte<EInterpCurveMode> */ __um(InterpMode);                                      // 0x0070   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(1,16) /* TEnumAsByte<EInterpCurveMode> */ __um(InterpMode);                                      // 0x0098   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(1,17) /* TEnumAsByte<EInterpCurveMode> */ __um(InterpMode);                                      // 0x0050   (0x0001)  
...
{ 
	...
	SDK_UNDEFINED(1,18) /* TEnumAsByte<EInterpCurveMode> */ __um(InterpMode);                                      // 0x0038   (0x0001)  
...
{ 
	...
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0001   (0x0007)  MISSED
	SDK_UNDEFINED(16,19) /* FString */                 __um(NativeCulture);                                        // 0x0008   (0x0010)  
	SDK_UNDEFINED(16,20) /* FString */                 __um(Namespace);                                            // 0x0018   (0x0010)  
	SDK_UNDEFINED(16,21) /* FString */                 __um(Key);                                                  // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,22) /* FString */                 __um(NativeString);                                         // 0x0038   (0x0010)  
	SDK_UNDEFINED(80,23) /* TMap<FString, FString> */  __um(LocalizedStrings);                                     // 0x0048   (0x0050)  
	bool                                               bIsMinimalPatch;                                            // 0x0098   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0099   (0x0007)  MISSED
	SDK_UNDEFINED(24,24) /* FText */                   __um(CachedText);                                           // 0x00A0   (0x0018)  
};
...
{ 
	SDK_UNDEFINED(16,25) /* FString */                 __um(Template);                                             // 0x0000   (0x0010)  
};
