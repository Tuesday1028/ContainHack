...
{ 
public:
	SDK_UNDEFINED(80,2046) /* TSet<AChaosSolverActor*> */ __um(ChaosSolverActorSet);                               // 0x0038   (0x0050)  
	...
	SDK_UNDEFINED(80,2047) /* TSet<UPhysicalMaterial*> */ __um(ChaosBreakingMaterialSet);                          // 0x01C0   (0x0050)  
