...
{ 
	SDK_UNDEFINED(16,2292) /* FString */               __um(CurrentLevel);                                         // 0x0000   (0x0010)  
	...
	SDK_UNDEFINED(16,2293) /* FString */               __um(InstanceType);                                         // 0x0028   (0x0010)  
...
{ 
	SDK_UNDEFINED(16,2294) /* FString */               __um(username);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2295) /* FString */               __um(UserToDeny);                                           // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2296) /* FString */               __um(username);                                             // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2297) /* FString */               __um(UserToGrant);                                          // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2298) /* FString */               __um(Command);                                              // 0x0000   (0x0010)  
	SDK_UNDEFINED(16,2299) /* FString */               __um(username);                                             // 0x0010   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2300) /* FString */               __um(username);                                             // 0x0000   (0x0010)  
};
...
{ 
	SDK_UNDEFINED(16,2301) /* FString */               __um(Text);                                                 // 0x0000   (0x0010)  
