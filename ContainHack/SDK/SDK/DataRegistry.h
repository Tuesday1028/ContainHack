...
public:
	...
	SDK_UNDEFINED(80,2160) /* TMap<FName, UDataRegistrySource*> */ __um(RuntimeChildren);                          // 0x0090   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(48,2161) /* TWeakObjectPtr<UCurveTable*> */ __um(SourceTable);                                   // 0x0038   (0x0030)  
	FDataRegistrySource_DataTableRules                 TableRules;                                                 // 0x0068   (0x0008)  
	class UCurveTable*                                 CachedTable;                                                // 0x0070   (0x0008)  
	class UCurveTable*                                 PreloadTable;                                               // 0x0078   (0x0008)  
...
{ 
public:
	SDK_UNDEFINED(48,2162) /* TWeakObjectPtr<UDataTable*> */ __um(SourceTable);                                    // 0x0038   (0x0030)  
	FDataRegistrySource_DataTableRules                 TableRules;                                                 // 0x0068   (0x0008)  
	class UDataTable*                                  CachedTable;                                                // 0x0070   (0x0008)  
	class UDataTable*                                  PreloadTable;                                               // 0x0078   (0x0008)  
	unsigned char                                      UnknownData00_6[0x28];                                      // 0x0080   (0x0028)  MISSED
};
...
public:
	...
	// bool NotEqual_DataRegistryType(FDataRegistryType A, FDataRegistryType B);                                             // [0x3857220] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/DataRegistry.DataRegistrySubsystem.NotEqual_DataRegistryId
	// bool NotEqual_DataRegistryId(FDataRegistryId A, FDataRegistryId B);                                                   // [0x3e43d00] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/DataRegistry.DataRegistrySubsystem.IsValidDataRegistryType
	// bool IsValidDataRegistryType(FDataRegistryType DataRegistryType);                                                     // [0x38565a0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/DataRegistry.DataRegistrySubsystem.IsValidDataRegistryId
	// bool IsValidDataRegistryId(FDataRegistryId DataRegistryId);                                                           // [0x3e2f070] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/DataRegistry.DataRegistrySubsystem.GetCachedItemFromLookupBP
	// bool GetCachedItemFromLookupBP(FDataRegistryId ItemId, FDataRegistryLookup& ResolvedLookup, FTableRowBase& OutItem);  // [0x45a8680] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DataRegistry.DataRegistrySubsystem.GetCachedItemBP
	// bool GetCachedItemBP(FDataRegistryId ItemId, FTableRowBase& OutItem);                                                 // [0x45a8490] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DataRegistry.DataRegistrySubsystem.FindCachedItemBP
	// void FindCachedItemBP(FDataRegistryId ItemId, EDataRegistrySubsystemGetItemResult& OutResult, FTableRowBase& OutItem); // [0x45a8270] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DataRegistry.DataRegistrySubsystem.EvaluateDataRegistryCurve
	// void EvaluateDataRegistryCurve(FDataRegistryId ItemId, float InputValue, float DefaultValue, EDataRegistrySubsystemGetItemResult& OutResult, float& OutValue); // [0x45a7fe0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DataRegistry.DataRegistrySubsystem.EqualEqual_DataRegistryType
	// bool EqualEqual_DataRegistryType(FDataRegistryType A, FDataRegistryType B);                                           // [0x3855250] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/DataRegistry.DataRegistrySubsystem.EqualEqual_DataRegistryId
	// bool EqualEqual_DataRegistryId(FDataRegistryId A, FDataRegistryId B);                                                 // [0x3e1e4d0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/DataRegistry.DataRegistrySubsystem.Conv_DataRegistryTypeToString
	// FString Conv_DataRegistryTypeToString(FDataRegistryType DataRegistryType);                                            // [0x3855690] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/DataRegistry.DataRegistrySubsystem.Conv_DataRegistryIdToString
	// FString Conv_DataRegistryIdToString(FDataRegistryId DataRegistryId);                                                  // [0x45a7e70] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/DataRegistry.DataRegistrySubsystem.AcquireItemBP
	// bool AcquireItemBP(FDataRegistryId ItemId, FDelegateProperty AcquireCallback);                                        // [0x45a7c40] Final|Native|Static|Public|BlueprintCallable 
};
