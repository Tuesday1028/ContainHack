...
public:
	...
	// void StopLink();                                                                                                      // [0x3774e00] Native|Public|BlueprintCallable 
	// Function /Script/AudioLinkEngine.AudioLinkBlueprintInterface.SetLinkSound
	// void SetLinkSound(class USoundBase* NewSound);                                                                        // [0x3774d70] Native|Public|BlueprintCallable 
	// Function /Script/AudioLinkEngine.AudioLinkBlueprintInterface.PlayLink
	// void PlayLink(float StartTime);                                                                                       // [0x3774ce0] Native|Public|BlueprintCallable 
	// Function /Script/AudioLinkEngine.AudioLinkBlueprintInterface.IsLinkPlaying
	// bool IsLinkPlaying();                                                                                                 // [0x3774cb0] Native|Public|BlueprintCallable|BlueprintPure|Const 
};
