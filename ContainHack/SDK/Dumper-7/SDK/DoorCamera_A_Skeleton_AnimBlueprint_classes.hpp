...
class UDoorCamera_A_Skeleton_AnimBlueprint_C : public UAnimInstance
{
public:
	...
	static class UDoorCamera_A_Skeleton_AnimBlueprint_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_DoorCamera_A_Skeleton_AnimBlueprint(int32 EntryPoint);
};
