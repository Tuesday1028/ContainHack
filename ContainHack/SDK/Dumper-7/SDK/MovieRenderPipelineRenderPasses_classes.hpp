...
{
public:
	uint8                                        Pad_2D2[0x130];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2D3[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2D5[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FActorLayer>                   ActorLayers;                                       // 0x198(0x10)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_2D6[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2D7[0x48];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2DC[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2DD[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2E2[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
