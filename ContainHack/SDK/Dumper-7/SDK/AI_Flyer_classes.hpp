...
// 0x58 (0x670 - 0x618)
// BlueprintGeneratedClass AI_Flyer.AI_Flyer_C
class UAI_Flyer_C : public UCharacter
{
public:
	uint8                                        Pad_344D[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class UPointLightComponent*                  PointLight;                                        // 0x630(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UAudioComponent*                       Movement;                                          // 0x638(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UNiagaraComponent*                     Niagara;                                           // 0x640(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	static class UAI_Flyer_C* GetDefaultObj();
