...
{
public:
	uint8                                        Pad_B40[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	class ULevelSequenceActor*                   LevelSequenceActor;                                // 0x328(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_BC6[0x100];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_BF0[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
