...
struct UNVWidget_C_ExecuteUbergraph_NVWidget_Params
{
public:
	...
	TArray<class UNVWidget_C*>                   CallFunc_GetAllWidgetsOfClass_FoundWidgets;        // 0x18(0x10)(ReferenceParm, ContainsInstancedReference)
	int32                                        CallFunc_Array_Length_ReturnValue;                 // 0x28(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_32EB[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UNVWidget_C*                           CallFunc_Array_Get_Item;                           // 0x30(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
