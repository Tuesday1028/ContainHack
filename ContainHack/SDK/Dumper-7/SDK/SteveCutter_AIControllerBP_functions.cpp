...
// BlueprintGeneratedClass SteveCutter_AIControllerBP.SteveCutter_AIControllerBP_C
// (Actor)

class UClass* USteveCutter_AIControllerBP_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("SteveCutter_AIControllerBP_C");

	return Clss;
}


// SteveCutter_AIControllerBP_C SteveCutter_AIControllerBP.Default__SteveCutter_AIControllerBP_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class USteveCutter_AIControllerBP_C* USteveCutter_AIControllerBP_C::GetDefaultObj()
{
	static class USteveCutter_AIControllerBP_C* Default = nullptr;

	if (!Default)
		Default = static_cast<USteveCutter_AIControllerBP_C*>(USteveCutter_AIControllerBP_C::StaticClass()->DefaultObject);
...
// Function SteveCutter_AIControllerBP.SteveCutter_AIControllerBP_C.ConfigureAIFromPrediction
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:

void USteveCutter_AIControllerBP_C::ConfigureAIFromPrediction()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SteveCutter_AIControllerBP_C", "ConfigureAIFromPrediction");
...
// Parameters:
// class UAI_Steve_C*                 CurrentCloseFriend                                               (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
// TArray<class UAI_Steve_C*>         CloseFriends                                                     (Edit, BlueprintVisible, DisableEditOnTemplate)
...
// TArray<class UAI_Steve_C*>         CallFunc_GetAllActorsOfClass_OutActors                           (ReferenceParm)
// class FName                        CallFunc_MakeLiteralName_ReturnValue_7                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UAI_Steve_C*                 CallFunc_Array_Get_Item_1                                        (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void USteveCutter_AIControllerBP_C::ReceivePossess(class UPawn* PossessedPawn)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SteveCutter_AIControllerBP_C", "ReceivePossess");

	Params::USteveCutter_AIControllerBP_C_ReceivePossess_Params Parms{};
...
void USteveCutter_AIControllerBP_C::BndEvt__Soldiers_AIControllerBP_AIPerception_K2Node_ComponentBoundEvent_1_ActorPerceptionUpdatedDelegate__DelegateSignature(class UActor* Actor, const struct FAIStimulus& Stimulus)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SteveCutter_AIControllerBP_C", "BndEvt__Soldiers_AIControllerBP_AIPerception_K2Node_ComponentBoundEvent_1_ActorPerceptionUpdatedDelegate__DelegateSignature");

	Params::USteveCutter_AIControllerBP_C_BndEvt__Soldiers_AIControllerBP_AIPerception_K2Node_ComponentBoundEvent_1_ActorPerceptionUpdatedDelegate__DelegateSignature_Params Parms{};
