...
// 0x28 (0x2B8 - 0x290)
// BlueprintGeneratedClass FPS_9_mmKovan.FPS_9_mmKovan_C
class UFPS_9_mmKovan_C : public UActor
{
public:
	...
	static class UFPS_9_mmKovan_C* GetDefaultObj();
	...
	void ExecuteUbergraph_FPS_9_mmKovan(int32 EntryPoint, bool Temp_bool_Has_Been_Initd_Variable, bool Temp_bool_IsClosed_Variable, float K2Node_Event_DeltaSeconds);
};
