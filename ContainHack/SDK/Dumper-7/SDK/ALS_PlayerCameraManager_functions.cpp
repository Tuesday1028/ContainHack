...
class UClass* UALS_PlayerCameraManager_C::StaticClass()
{
...
class UALS_PlayerCameraManager_C* UALS_PlayerCameraManager_C::GetDefaultObj()
{
	static class UALS_PlayerCameraManager_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UALS_PlayerCameraManager_C*>(UALS_PlayerCameraManager_C::StaticClass()->DefaultObject);
...
void UALS_PlayerCameraManager_C::DrawDebugTargets(const struct FVector& PivotTargetLocation, bool CallFunc_IsDedicatedServer_ReturnValue, const struct FVector& CallFunc_BreakTransform_Location, const struct FRotator& CallFunc_BreakTransform_Rotation, const struct FVector& CallFunc_BreakTransform_Scale, const struct FVector& CallFunc_BreakTransform_Location_1, const struct FRotator& CallFunc_BreakTransform_Rotation_1, const struct FVector& CallFunc_BreakTransform_Scale_1, const struct FVector& CallFunc_BreakTransform_Location_2, const struct FRotator& CallFunc_BreakTransform_Rotation_2, const struct FVector& CallFunc_BreakTransform_Scale_2)
{
	...
	Params::UALS_PlayerCameraManager_C_DrawDebugTargets_Params Parms{};
