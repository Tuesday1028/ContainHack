...
class UClass* UBTTask_NewCoverSystem_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BTTask_NewCoverSystem_C");

	return Clss;
}


// BTTask_NewCoverSystem_C BTTask_NewCoverSystem.Default__BTTask_NewCoverSystem_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBTTask_NewCoverSystem_C* UBTTask_NewCoverSystem_C::GetDefaultObj()
{
	static class UBTTask_NewCoverSystem_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBTTask_NewCoverSystem_C*>(UBTTask_NewCoverSystem_C::StaticClass()->DefaultObject);
...
void UBTTask_NewCoverSystem_C::ReceiveExecuteAI(class UAIController* OwnerController, class UPawn* ControlledPawn)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BTTask_NewCoverSystem_C", "ReceiveExecuteAI");

	Params::UBTTask_NewCoverSystem_C_ReceiveExecuteAI_Params Parms{};
...
// struct FRotator                    CallFunc_GetBlackboardValueAsRotator_ReturnValue                 (ZeroConstructor, IsPlainOldData, NoDestructor)
