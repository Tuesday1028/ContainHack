...
// (Event, Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UPlayerController*           Controller                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UDebugComponent_C::OnPlayerControllerInitialized(class UPlayerController* Controller)
{
	static class UFunction* Func = nullptr;
...
// class UPlayerController*           K2Node_Event_Controller                                          (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// class UALS_Player_Controller_C*    K2Node_DynamicCast_AsALS_Player_Controller                       (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UDebugComponent_C::ExecuteUbergraph_DebugComponent(int32 EntryPoint, class UPlayerController* K2Node_Event_Controller, class UALS_HUD_C* CallFunc_Create_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, bool CallFunc_IsLocalController_ReturnValue, bool K2Node_Event_bValue_1, bool K2Node_Event_bValue, class UController* CallFunc_GetController_ReturnValue, class UALS_Player_Controller_C* K2Node_DynamicCast_AsALS_Player_Controller, bool K2Node_DynamicCast_bSuccess, class UOverlayStateSwitcher_C* CallFunc_Create_ReturnValue_1)
{
	static class UFunction* Func = nullptr;
