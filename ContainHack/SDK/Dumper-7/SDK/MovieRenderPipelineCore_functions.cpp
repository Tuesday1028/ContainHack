...
class UClass* UMoviePipelineGameMode::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UMoviePipelineGameMode* UMoviePipelineGameMode::GetDefaultObj()
{
	static class UMoviePipelineGameMode* Default = nullptr;

	if (!Default)
		Default = static_cast<UMoviePipelineGameMode*>(UMoviePipelineGameMode::StaticClass()->DefaultObject);
