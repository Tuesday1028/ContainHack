...
class UClass* UBP_Audio_Area_C::StaticClass()
{
...
class UBP_Audio_Area_C* UBP_Audio_Area_C::GetDefaultObj()
{
	static class UBP_Audio_Area_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_Audio_Area_C*>(UBP_Audio_Area_C::StaticClass()->DefaultObject);
...
void UBP_Audio_Area_C::VisualizeArea(bool bNewVisibility)
{
	...
	Params::UBP_Audio_Area_C_VisualizeArea_Params Parms{};
...
// TArray<class UBP_Audio_Manager_C*> CallFunc_GetAllActorsOfClass_OutActors                           (ReferenceParm)
// class UBP_Audio_Manager_C*         CallFunc_Array_Get_Item                                          (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UBP_Audio_Area_C::UserConstructionScript(int32 Temp_int_Variable, class UMaterialInterface* Temp_object_Variable, class UMaterialInterface* Temp_object_Variable_1, class UMaterialInterface* Temp_object_Variable_2, class UMaterialInterface* Temp_object_Variable_3, class UMaterialInterface* Temp_object_Variable_4, class UMaterialInterface* Temp_object_Variable_5, int32 Temp_int_Variable_1, const struct FColor& K2Node_MakeStruct_Color, const struct FColor& K2Node_MakeStruct_Color_1, const struct FColor& K2Node_MakeStruct_Color_2, const struct FColor& K2Node_MakeStruct_Color_3, TArray<class UBP_Audio_Manager_C*>& CallFunc_GetAllActorsOfClass_OutActors, class UBP_Audio_Manager_C* CallFunc_Array_Get_Item, class UMaterialInterface* K2Node_Select_Default, const class FString& CallFunc_Conv_IntToString_ReturnValue, class FText CallFunc_Conv_StringToText_ReturnValue, const struct FColor& K2Node_Select_Default_1)
{
	...
	Params::UBP_Audio_Area_C_UserConstructionScript_Params Parms{};
...
void UBP_Audio_Area_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;
...
void UBP_Audio_Area_C::BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class UActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_Audio_Area_C_BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params Parms{};
...
void UBP_Audio_Area_C::BndEvt__Box_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class UActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_Audio_Area_C_BndEvt__Box_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature_Params Parms{};
...
// Parameters:
// class UBP_Audio_Manager_C*         AudioReference                                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UBP_Audio_Area_C::NewAudioManager(class UBP_Audio_Manager_C* AudioReference)
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_Audio_Area_C_NewAudioManager_Params Parms{};
...
// class UBP_Audio_Area_C*            Temp_object_Variable                                             (ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UBP_Audio_Area_C::ExecuteUbergraph_BP_Audio_Area(int32 EntryPoint, class UBP_Audio_Area_C* Temp_object_Variable, class UPrimitiveComponent* K2Node_ComponentBoundEvent_OverlappedComponent_1, class UActor* K2Node_ComponentBoundEvent_OtherActor_1, class UPrimitiveComponent* K2Node_ComponentBoundEvent_OtherComp_1, int32 K2Node_ComponentBoundEvent_OtherBodyIndex_1, bool K2Node_ComponentBoundEvent_bFromSweep, const struct FHitResult& K2Node_ComponentBoundEvent_SweepResult, class UPrimitiveComponent* K2Node_ComponentBoundEvent_OverlappedComponent, class UActor* K2Node_ComponentBoundEvent_OtherActor, class UPrimitiveComponent* K2Node_ComponentBoundEvent_OtherComp, int32 K2Node_ComponentBoundEvent_OtherBodyIndex, class UCharacter* CallFunc_GetPlayerCharacter_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_EqualEqual_ObjectObject_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, bool CallFunc_EqualEqual_NameName_ReturnValue, TArray<class UBP_Audio_Manager_C*>& CallFunc_GetAllActorsOfClass_OutActors, class UCharacter* CallFunc_GetPlayerCharacter_ReturnValue_1, class UBP_Audio_Manager_C* CallFunc_Array_Get_Item, bool CallFunc_EqualEqual_ObjectObject_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_2, bool CallFunc_IsValid_ReturnValue_3, bool CallFunc_Greater_IntInt_ReturnValue, int32 CallFunc_Array_Find_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue, class UBP_Audio_Manager_C* K2Node_CustomEvent_AudioReference)
{
	...
	Params::UBP_Audio_Area_C_ExecuteUbergraph_BP_Audio_Area_Params Parms{};
