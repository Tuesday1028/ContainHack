...
// BlueprintGeneratedClass BP_300GaBigBox.BP_300GaBigBox_C
// (Actor)

class UClass* UBP_300GaBigBox_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_300GaBigBox_C");

	return Clss;
}


// BP_300GaBigBox_C BP_300GaBigBox.Default__BP_300GaBigBox_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_300GaBigBox_C* UBP_300GaBigBox_C::GetDefaultObj()
{
	static class UBP_300GaBigBox_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_300GaBigBox_C*>(UBP_300GaBigBox_C::StaticClass()->DefaultObject);
