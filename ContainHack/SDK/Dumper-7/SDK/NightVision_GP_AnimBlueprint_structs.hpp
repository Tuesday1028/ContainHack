...
namespace SDK
{
	namespace NightVision_GP_AnimBlueprint
	{
		//---------------------------------------------------------------------------------------------------------------------
		// ENUMS
		//---------------------------------------------------------------------------------------------------------------------
		...
		// 0xF7 (0xF8 - 0x1)
		// ScriptStruct NightVision_GP_AnimBlueprint.NightVision_GP_AnimBlueprint_C.AnimBlueprintGeneratedConstantData
		...
		// 0x1 (0x2 - 0x1)
		// ScriptStruct NightVision_GP_AnimBlueprint.NightVision_GP_AnimBlueprint_C.AnimBlueprintGeneratedMutableData
