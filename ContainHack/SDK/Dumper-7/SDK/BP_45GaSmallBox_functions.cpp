...
class UClass* UBP_45GaSmallBox_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_45GaSmallBox_C");

	return Clss;
}


// BP_45GaSmallBox_C BP_45GaSmallBox.Default__BP_45GaSmallBox_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_45GaSmallBox_C* UBP_45GaSmallBox_C::GetDefaultObj()
{
	static class UBP_45GaSmallBox_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_45GaSmallBox_C*>(UBP_45GaSmallBox_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_45GaSmallBox.BP_45GaSmallBox_C.UserConstructionScript
