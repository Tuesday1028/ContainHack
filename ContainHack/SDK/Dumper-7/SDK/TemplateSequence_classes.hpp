...
public:
	...
	TSoftObjectPtr<class UActor>                 BoundPreviewActor;                                 // 0xA0(0x30)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_D87[0x7C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_D8D[0x260];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_D8E[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_D9B[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_DB1[0x70];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_DB6[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_DBF[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DE6[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_DFE[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
