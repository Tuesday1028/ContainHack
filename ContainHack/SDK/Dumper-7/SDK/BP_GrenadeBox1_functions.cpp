...
// BlueprintGeneratedClass BP_GrenadeBox1.BP_GrenadeBox1_C
// (Actor)

class UClass* UBP_GrenadeBox1_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_GrenadeBox1_C");

	return Clss;
}


// BP_GrenadeBox1_C BP_GrenadeBox1.Default__BP_GrenadeBox1_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_GrenadeBox1_C* UBP_GrenadeBox1_C::GetDefaultObj()
{
	static class UBP_GrenadeBox1_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_GrenadeBox1_C*>(UBP_GrenadeBox1_C::StaticClass()->DefaultObject);
