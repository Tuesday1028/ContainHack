...
class UClass* UDatasmithAreaLightActor::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UDatasmithAreaLightActor* UDatasmithAreaLightActor::GetDefaultObj()
{
	static class UDatasmithAreaLightActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UDatasmithAreaLightActor*>(UDatasmithAreaLightActor::StaticClass()->DefaultObject);
...
class UClass* UDatasmithImportedSequencesActor::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UDatasmithImportedSequencesActor* UDatasmithImportedSequencesActor::GetDefaultObj()
{
	static class UDatasmithImportedSequencesActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UDatasmithImportedSequencesActor*>(UDatasmithImportedSequencesActor::StaticClass()->DefaultObject);
...
void UDatasmithImportedSequencesActor::PlayLevelSequence(class ULevelSequence* SequenceToPlay)
{
	...
	Params::UDatasmithImportedSequencesActor_PlayLevelSequence_Params Parms{};
...
class UClass* UDatasmithSceneActor::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UDatasmithSceneActor* UDatasmithSceneActor::GetDefaultObj()
{
	static class UDatasmithSceneActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UDatasmithSceneActor*>(UDatasmithSceneActor::StaticClass()->DefaultObject);
