...
class UMultiTool_Skeleton_AnimBlueprint_C : public UAnimInstance
{
public:
	...
	static class UMultiTool_Skeleton_AnimBlueprint_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_MultiTool_Skeleton_AnimBlueprint(int32 EntryPoint);
};
