...
{
public:
	uint8                                        Pad_14FA[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_14FB[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_150F[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1519[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_151A[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FRigUnit_FitChainToCurve_DebugSettings DebugSettings;                                     // 0xE0(0x90)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FRigUnit_FitChainToCurve_WorkData     WorkData;                                          // 0x170(0x98)(Transient, NativeAccessSpecifierPublic)
	uint8                                        Pad_151F[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
