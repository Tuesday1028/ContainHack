...
// BlueprintGeneratedClass TPS_5_56Kovan.TPS_5_56Kovan_C
// (Actor)

class UClass* UTPS_5_56Kovan_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("TPS_5_56Kovan_C");

	return Clss;
}


// TPS_5_56Kovan_C TPS_5_56Kovan.Default__TPS_5_56Kovan_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTPS_5_56Kovan_C* UTPS_5_56Kovan_C::GetDefaultObj()
{
	static class UTPS_5_56Kovan_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTPS_5_56Kovan_C*>(UTPS_5_56Kovan_C::StaticClass()->DefaultObject);
...
void UTPS_5_56Kovan_C::ReceiveTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("TPS_5_56Kovan_C", "ReceiveTick");

	Params::UTPS_5_56Kovan_C_ReceiveTick_Params Parms{};
...
void UTPS_5_56Kovan_C::ExecuteUbergraph_TPS_5_56Kovan(int32 EntryPoint, bool Temp_bool_Has_Been_Initd_Variable, bool Temp_bool_IsClosed_Variable, float K2Node_Event_DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("TPS_5_56Kovan_C", "ExecuteUbergraph_TPS_5_56Kovan");

	Params::UTPS_5_56Kovan_C_ExecuteUbergraph_TPS_5_56Kovan_Params Parms{};
