...
struct UBP_ScientificDevice02_C_UserConstructionScript_Params
{
public:
	...
	struct FHitResult                            CallFunc_K2_AddRelativeLocation_SweepHitResult;    // 0x20(0xE8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FHitResult                            CallFunc_K2_AddRelativeLocation_SweepHitResult_1;  // 0x150(0xE8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FHitResult                            CallFunc_K2_SetRelativeRotation_SweepHitResult;    // 0x238(0xE8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	float                                        CallFunc_MakeRotator_Pitch_ImplicitCast;           // 0x320(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
