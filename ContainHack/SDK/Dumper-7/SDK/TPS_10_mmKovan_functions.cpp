...
// BlueprintGeneratedClass TPS_10_mmKovan.TPS_10_mmKovan_C
// (Actor)

class UClass* UTPS_10_mmKovan_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("TPS_10_mmKovan_C");

	return Clss;
}


// TPS_10_mmKovan_C TPS_10_mmKovan.Default__TPS_10_mmKovan_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTPS_10_mmKovan_C* UTPS_10_mmKovan_C::GetDefaultObj()
{
	static class UTPS_10_mmKovan_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTPS_10_mmKovan_C*>(UTPS_10_mmKovan_C::StaticClass()->DefaultObject);

	return Default;
}


// Function TPS_10_mmKovan.TPS_10_mmKovan_C.UserConstructionScript
...
// Function TPS_10_mmKovan.TPS_10_mmKovan_C.ReceiveTick
// (Event, Public, BlueprintEvent)
// Parameters:
// float                              DeltaSeconds                                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UTPS_10_mmKovan_C::ReceiveTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("TPS_10_mmKovan_C", "ReceiveTick");

	Params::UTPS_10_mmKovan_C_ReceiveTick_Params Parms{};
...
// Function TPS_10_mmKovan.TPS_10_mmKovan_C.ExecuteUbergraph_TPS_10_mmKovan
...
void UTPS_10_mmKovan_C::ExecuteUbergraph_TPS_10_mmKovan(int32 EntryPoint, bool Temp_bool_Has_Been_Initd_Variable, bool Temp_bool_IsClosed_Variable, float K2Node_Event_DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("TPS_10_mmKovan_C", "ExecuteUbergraph_TPS_10_mmKovan");

	Params::UTPS_10_mmKovan_C_ExecuteUbergraph_TPS_10_mmKovan_Params Parms{};
