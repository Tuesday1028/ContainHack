...
struct UBP_Audio_Area_C_VisualizeArea_Params
{
public:
...
struct UBP_Audio_Area_C_UserConstructionScript_Params
{
public:
	...
	TArray<class UBP_Audio_Manager_C*>           CallFunc_GetAllActorsOfClass_OutActors;            // 0x50(0x10)(ReferenceParm)
	class UBP_Audio_Manager_C*                   CallFunc_Array_Get_Item;                           // 0x60(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
struct UBP_Audio_Area_C_BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params
{
public:
...
struct UBP_Audio_Area_C_BndEvt__Box_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature_Params
{
public:
	class UPrimitiveComponent*                   OverlappedComponent;                               // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UActor*                                OtherActor;                                        // 0x8(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
struct UBP_Audio_Area_C_NewAudioManager_Params
{
public:
	class UBP_Audio_Manager_C*                   AudioReference;                                    // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};

// 0x180 (0x180 - 0x0)
// Function BP_Audio_Area.BP_Audio_Area_C.ExecuteUbergraph_BP_Audio_Area
struct UBP_Audio_Area_C_ExecuteUbergraph_BP_Audio_Area_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3808[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UBP_Audio_Area_C*                      Temp_object_Variable;                              // 0x8(0x8)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UCharacter*                            CallFunc_GetPlayerCharacter_ReturnValue;           // 0x138(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class UBP_Audio_Manager_C*>           CallFunc_GetAllActorsOfClass_OutActors;            // 0x148(0x10)(ReferenceParm)
	class UCharacter*                            CallFunc_GetPlayerCharacter_ReturnValue_1;         // 0x158(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UBP_Audio_Manager_C*                   CallFunc_Array_Get_Item;                           // 0x160(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UBP_Audio_Manager_C*                   K2Node_CustomEvent_AudioReference;                 // 0x178(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
