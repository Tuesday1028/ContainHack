...
class UTPS_5_56Kovan_C : public UActor
{
public:
	...
	static class UTPS_5_56Kovan_C* GetDefaultObj();
	...
	void ExecuteUbergraph_TPS_5_56Kovan(int32 EntryPoint, bool Temp_bool_Has_Been_Initd_Variable, bool Temp_bool_IsClosed_Variable, float K2Node_Event_DeltaSeconds);
};
