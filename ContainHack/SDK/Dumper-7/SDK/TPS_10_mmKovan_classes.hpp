...
class UTPS_10_mmKovan_C : public UActor
{
public:
	...
	static class UTPS_10_mmKovan_C* GetDefaultObj();
	...
	void ExecuteUbergraph_TPS_10_mmKovan(int32 EntryPoint, bool Temp_bool_Has_Been_Initd_Variable, bool Temp_bool_IsClosed_Variable, float K2Node_Event_DeltaSeconds);
};
