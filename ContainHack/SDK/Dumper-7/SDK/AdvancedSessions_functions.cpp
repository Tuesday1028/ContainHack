...
void UAdvancedExternalUILibrary::ShowInviteUI(class UPlayerController* PlayerController, enum class EBlueprintResultSwitch* Result)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedExternalUILibrary::ShowFriendsUI(class UPlayerController* PlayerController, enum class EBlueprintResultSwitch* Result)
{
	static class UFunction* Func = nullptr;
...
class UClass* UAdvancedFriendsInterface::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UAdvancedFriendsInterface* UAdvancedFriendsInterface::GetDefaultObj()
{
	static class UAdvancedFriendsInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<UAdvancedFriendsInterface*>(UAdvancedFriendsInterface::StaticClass()->DefaultObject);
...
void UAdvancedFriendsInterface::OnSessionInviteReceived(const struct FBPUniqueNetId& PersonInviting, struct FBlueprintSessionResult& SearchResult)
{
	static class UFunction* Func = nullptr;
	...
	Params::UAdvancedFriendsInterface_OnSessionInviteReceived_Params Parms{};
...
void UAdvancedFriendsInterface::OnSessionInviteAccepted(const struct FBPUniqueNetId& PersonInvited, struct FBlueprintSessionResult& SearchResult)
{
	static class UFunction* Func = nullptr;
	...
	Params::UAdvancedFriendsInterface_OnSessionInviteAccepted_Params Parms{};
...
void UAdvancedFriendsInterface::OnPlayerVoiceStateChanged(const struct FBPUniqueNetId& PlayerId, bool bIsTalking)
{
	...
	Params::UAdvancedFriendsInterface_OnPlayerVoiceStateChanged_Params Parms{};
...
void UAdvancedFriendsInterface::OnPlayerLoginStatusChanged(enum class EBPLoginStatus PreviousStatus, enum class EBPLoginStatus NewStatus, const struct FBPUniqueNetId& PlayerUniqueNetID)
{
	static class UFunction* Func = nullptr;
	...
	Params::UAdvancedFriendsInterface_OnPlayerLoginStatusChanged_Params Parms{};
...
void UAdvancedFriendsInterface::OnPlayerLoginChanged(int32 PlayerNum)
{
	static class UFunction* Func = nullptr;
	...
	Params::UAdvancedFriendsInterface_OnPlayerLoginChanged_Params Parms{};
...
void UAdvancedFriendsLibrary::SendSessionInviteToFriends(class UPlayerController* PlayerController, TArray<struct FBPUniqueNetId>& Friends, enum class EBlueprintResultSwitch* Result)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedFriendsLibrary::SendSessionInviteToFriend(class UPlayerController* PlayerController, struct FBPUniqueNetId& FriendUniqueNetId, enum class EBlueprintResultSwitch* Result)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedFriendsLibrary::IsAFriend(class UPlayerController* PlayerController, const struct FBPUniqueNetId& UniqueNetId, bool* IsFriend)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedFriendsLibrary::GetStoredFriendsList(class UPlayerController* PlayerController, TArray<struct FBPFriendInfo>* FriendsList)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedFriendsLibrary::GetFriend(class UPlayerController* PlayerController, const struct FBPUniqueNetId& FriendUniqueNetId, struct FBPFriendInfo* Friend)
{
	static class UFunction* Func = nullptr;
...
class UClass* UAdvancedGameSession::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UAdvancedGameSession* UAdvancedGameSession::GetDefaultObj()
{
	static class UAdvancedGameSession* Default = nullptr;

	if (!Default)
		Default = static_cast<UAdvancedGameSession*>(UAdvancedGameSession::StaticClass()->DefaultObject);
...
void UAdvancedIdentityLibrary::GetPlayerAuthToken(class UPlayerController* PlayerController, class FString* AuthToken, enum class EBlueprintResultSwitch* Result)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedSessionsLibrary::SetPlayerName(class UPlayerController* PlayerController, const class FString& PlayerName)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class UObject*                     WorldContextObject                                               (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UPlayerController*           PlayerToKick                                                     (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class FText                        KickReason                                                       (Parm, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UAdvancedSessionsLibrary::KickPlayer(class UObject* WorldContextObject, class UPlayerController* PlayerToKick, class FText KickReason)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedSessionsLibrary::GetUniqueNetIDFromPlayerState(class UPlayerState* PlayerState, struct FBPUniqueNetId* UniqueNetId)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedSessionsLibrary::GetUniqueNetID(class UPlayerController* PlayerController, struct FBPUniqueNetId* UniqueNetId)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedSessionsLibrary::GetPlayerName(class UPlayerController* PlayerController, class FString* PlayerName)
{
	static class UFunction* Func = nullptr;
...
void UAdvancedSessionsLibrary::GetNetPlayerIndex(class UPlayerController* PlayerController, int32* NetPlayerIndex)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class UObject*                     WorldContextObject                                               (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UPlayerController*           PlayerToBan                                                      (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class FText                        BanReason                                                        (Parm, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UAdvancedSessionsLibrary::BanPlayer(class UObject* WorldContextObject, class UPlayerController* PlayerToBan, class FText BanReason)
{
	static class UFunction* Func = nullptr;
...
class UCancelFindSessionsCallbackProxy* UCancelFindSessionsCallbackProxy::CancelFindSessions(class UObject* WorldContextObject, class UPlayerController* PlayerController)
{
	static class UFunction* Func = nullptr;
...
class UCreateSessionCallbackProxyAdvanced* UCreateSessionCallbackProxyAdvanced::CreateAdvancedSession(class UObject* WorldContextObject, TArray<struct FSessionPropertyKeyPair>& ExtraSettings, class UPlayerController* PlayerController, int32 PublicConnections, int32 PrivateConnections, bool bUseLAN, bool bAllowInvites, bool bIsDedicatedServer, bool bUsePresence, bool bUseLobbiesIfAvailable, bool bAllowJoinViaPresence, bool bAllowJoinViaPresenceFriendsOnly, bool bAntiCheatProtected, bool bUsesStats, bool bShouldAdvertise, bool bUseLobbiesVoiceChatIfAvailable, bool bStartAfterCreate)
{
	static class UFunction* Func = nullptr;
...
class UEndSessionCallbackProxy* UEndSessionCallbackProxy::EndSession(class UObject* WorldContextObject, class UPlayerController* PlayerController)
{
	static class UFunction* Func = nullptr;
...
class UFindFriendSessionCallbackProxy* UFindFriendSessionCallbackProxy::FindFriendSession(class UObject* WorldContextObject, class UPlayerController* PlayerController, struct FBPUniqueNetId& FriendUniqueNetId)
{
	static class UFunction* Func = nullptr;
...
class UFindSessionsCallbackProxyAdvanced* UFindSessionsCallbackProxyAdvanced::FindSessionsAdvanced(class UObject* WorldContextObject, class UPlayerController* PlayerController, int32 MaxResults, bool bUseLAN, enum class EBPServerPresenceSearchType ServerTypeToSearch, TArray<struct FSessionsSearchSetting>& Filters, bool bEmptyServersOnly, bool bNonEmptyServersOnly, bool bSecureServersOnly, bool bSearchLobbies, int32 MinSlotsAvailable)
{
	static class UFunction* Func = nullptr;
...
class UGetFriendsCallbackProxy* UGetFriendsCallbackProxy::GetAndStoreFriendsList(class UObject* WorldContextObject, class UPlayerController* PlayerController)
{
	static class UFunction* Func = nullptr;
...
class ULoginUserCallbackProxy* ULoginUserCallbackProxy::LoginUser(class UObject* WorldContextObject, class UPlayerController* PlayerController, const class FString& UserId, const class FString& UserToken, const class FString& AuthType)
{
	static class UFunction* Func = nullptr;
...
class ULogoutUserCallbackProxy* ULogoutUserCallbackProxy::LogoutUser(class UObject* WorldContextObject, class UPlayerController* PlayerController)
{
	static class UFunction* Func = nullptr;
...
class USendFriendInviteCallbackProxy* USendFriendInviteCallbackProxy::SendFriendInvite(class UObject* WorldContextObject, class UPlayerController* PlayerController, struct FBPUniqueNetId& UniqueNetIDInvited)
{
	static class UFunction* Func = nullptr;
