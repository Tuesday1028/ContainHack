...
{
public:
	uint8                                        Pad_8A4[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_8C4[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_8C7[0xB];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_8C8[0x20];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_8CC[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
