...
class UClass* UBP_12GaBigBox_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_12GaBigBox_C");

	return Clss;
}


// BP_12GaBigBox_C BP_12GaBigBox.Default__BP_12GaBigBox_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_12GaBigBox_C* UBP_12GaBigBox_C::GetDefaultObj()
{
	static class UBP_12GaBigBox_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_12GaBigBox_C*>(UBP_12GaBigBox_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_12GaBigBox.BP_12GaBigBox_C.UserConstructionScript
