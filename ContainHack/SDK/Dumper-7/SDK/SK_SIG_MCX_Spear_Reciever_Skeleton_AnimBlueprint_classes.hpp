...
class USK_SIG_MCX_Spear_Reciever_Skeleton_AnimBlueprint_C : public UAnimInstance
{
public:
	...
	static class USK_SIG_MCX_Spear_Reciever_Skeleton_AnimBlueprint_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_SK_SIG_MCX_Spear_Reciever_Skeleton_AnimBlueprint(int32 EntryPoint);
};
