...
class UPin_Skeleton_AnimBlueprint_C : public UAnimInstance
{
public:
	...
	static class UPin_Skeleton_AnimBlueprint_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_Pin_Skeleton_AnimBlueprint(int32 EntryPoint);
};
