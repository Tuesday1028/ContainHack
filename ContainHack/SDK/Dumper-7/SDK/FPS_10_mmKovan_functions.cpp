...
// BlueprintGeneratedClass FPS_10_mmKovan.FPS_10_mmKovan_C
// (Actor)

class UClass* UFPS_10_mmKovan_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FPS_10_mmKovan_C");

	return Clss;
}


// FPS_10_mmKovan_C FPS_10_mmKovan.Default__FPS_10_mmKovan_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFPS_10_mmKovan_C* UFPS_10_mmKovan_C::GetDefaultObj()
{
	static class UFPS_10_mmKovan_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFPS_10_mmKovan_C*>(UFPS_10_mmKovan_C::StaticClass()->DefaultObject);

	return Default;
}


// Function FPS_10_mmKovan.FPS_10_mmKovan_C.UserConstructionScript
...
// Function FPS_10_mmKovan.FPS_10_mmKovan_C.ReceiveTick
// (Event, Public, BlueprintEvent)
// Parameters:
// float                              DeltaSeconds                                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UFPS_10_mmKovan_C::ReceiveTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("FPS_10_mmKovan_C", "ReceiveTick");

	Params::UFPS_10_mmKovan_C_ReceiveTick_Params Parms{};
...
// Function FPS_10_mmKovan.FPS_10_mmKovan_C.ExecuteUbergraph_FPS_10_mmKovan
...
void UFPS_10_mmKovan_C::ExecuteUbergraph_FPS_10_mmKovan(int32 EntryPoint, bool Temp_bool_Has_Been_Initd_Variable, bool Temp_bool_IsClosed_Variable, float K2Node_Event_DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("FPS_10_mmKovan_C", "ExecuteUbergraph_FPS_10_mmKovan");

	Params::UFPS_10_mmKovan_C_ExecuteUbergraph_FPS_10_mmKovan_Params Parms{};
