...
namespace SDK
{
	namespace SK_EMP_01_Skeleton_AnimBlueprint
	{
		//---------------------------------------------------------------------------------------------------------------------
		// ENUMS
		//---------------------------------------------------------------------------------------------------------------------
		...
		// 0x10F (0x110 - 0x1)
		// ScriptStruct SK_EMP_01_Skeleton_AnimBlueprint.SK_EMP_01_Skeleton_AnimBlueprint_C.AnimBlueprintGeneratedConstantData
		...
		public:
			...
			struct FAnimNodeFunctionRef                  __StructProperty_8;                                // 0x10(0x20)(BlueprintVisible, NoDestructor)
			...
			struct FInputScaleBiasClampConstants         __StructProperty_11;                               // 0x38(0x2C)(BlueprintVisible, NoDestructor)
			...
			uint8                                        Pad_3943[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
