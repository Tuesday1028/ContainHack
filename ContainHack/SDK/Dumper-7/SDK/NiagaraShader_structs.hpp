...
public:
	...
	uint8                                        Pad_6BF[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_6C0[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_6C4[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_6C9[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
