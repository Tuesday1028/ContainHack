...
public:
	...
	uint8                                        Pad_1098[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class UClass* StaticClass();
	static class UDatasmithAreaLightActor* GetDefaultObj();
...
public:
	...
	uint8                                        Pad_10AB[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_10F1[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1105[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1107[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	static class UClass* StaticClass();
	static class UDatasmithImportedSequencesActor* GetDefaultObj();
...
public:
	...
	uint8                                        Pad_114D[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1159[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        BitPad_9A : 5;                                     // Fixing Bit-Field Size  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_116F[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	TMap<class FName, TSoftObjectPtr<class UActor>> RelatedActors;                                     // 0x298(0x50)(Edit, EditConst, AdvancedDisplay, UObjectWrapper, NativeAccessSpecifierPublic)

	static class UClass* StaticClass();
	static class UDatasmithSceneActor* GetDefaultObj();
