...
class UClass* UBP_FirstAidKit2_02_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_FirstAidKit2_02_C");

	return Clss;
}


// BP_FirstAidKit2_02_C BP_FirstAidKit2_02.Default__BP_FirstAidKit2_02_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_FirstAidKit2_02_C* UBP_FirstAidKit2_02_C::GetDefaultObj()
{
	static class UBP_FirstAidKit2_02_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_FirstAidKit2_02_C*>(UBP_FirstAidKit2_02_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_FirstAidKit2_02.BP_FirstAidKit2_02_C.UserConstructionScript
