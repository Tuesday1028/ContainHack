...
namespace SDK
{
	namespace NightVision_A_Skeleton_AnimBlueprint {
		...
		// 0xF7 (0xF8 - 0x1)
		// ScriptStruct NightVision_A_Skeleton_AnimBlueprint.NightVision_A_Skeleton_AnimBlueprint_C.AnimBlueprintGeneratedConstantData
		...
		public:
			...
			uint8                                        Pad_37FD[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
		...
		// 0x1 (0x2 - 0x1)
		// ScriptStruct NightVision_A_Skeleton_AnimBlueprint.NightVision_A_Skeleton_AnimBlueprint_C.AnimBlueprintGeneratedMutableData
