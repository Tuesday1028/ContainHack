...
class UClass* USteveNailgun_AIControllerBP_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("SteveNailgun_AIControllerBP_C");

	return Clss;
}


// SteveNailgun_AIControllerBP_C SteveNailgun_AIControllerBP.Default__SteveNailgun_AIControllerBP_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class USteveNailgun_AIControllerBP_C* USteveNailgun_AIControllerBP_C::GetDefaultObj()
{
	static class USteveNailgun_AIControllerBP_C* Default = nullptr;

	if (!Default)
		Default = static_cast<USteveNailgun_AIControllerBP_C*>(USteveNailgun_AIControllerBP_C::StaticClass()->DefaultObject);
...
// Function SteveNailgun_AIControllerBP.SteveNailgun_AIControllerBP_C.ConfigureAIFromPrediction
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:

void USteveNailgun_AIControllerBP_C::ConfigureAIFromPrediction()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SteveNailgun_AIControllerBP_C", "ConfigureAIFromPrediction");
...
void USteveNailgun_AIControllerBP_C::ReceivePossess(class UPawn* PossessedPawn)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SteveNailgun_AIControllerBP_C", "ReceivePossess");

	Params::USteveNailgun_AIControllerBP_C_ReceivePossess_Params Parms{};
...
void USteveNailgun_AIControllerBP_C::BndEvt__Soldiers_AIControllerBP_AIPerception_K2Node_ComponentBoundEvent_1_ActorPerceptionUpdatedDelegate__DelegateSignature(class UActor* Actor, const struct FAIStimulus& Stimulus)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SteveNailgun_AIControllerBP_C", "BndEvt__Soldiers_AIControllerBP_AIPerception_K2Node_ComponentBoundEvent_1_ActorPerceptionUpdatedDelegate__DelegateSignature");

	Params::USteveNailgun_AIControllerBP_C_BndEvt__Soldiers_AIControllerBP_AIPerception_K2Node_ComponentBoundEvent_1_ActorPerceptionUpdatedDelegate__DelegateSignature_Params Parms{};
