...
// BlueprintGeneratedClass WeepingAngle_AIControllerBP.WeepingAngle_AIControllerBP_C
// (Actor)

class UClass* UWeepingAngle_AIControllerBP_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WeepingAngle_AIControllerBP_C");

	return Clss;
}


// WeepingAngle_AIControllerBP_C WeepingAngle_AIControllerBP.Default__WeepingAngle_AIControllerBP_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWeepingAngle_AIControllerBP_C* UWeepingAngle_AIControllerBP_C::GetDefaultObj()
{
	static class UWeepingAngle_AIControllerBP_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWeepingAngle_AIControllerBP_C*>(UWeepingAngle_AIControllerBP_C::StaticClass()->DefaultObject);

	return Default;
}


// Function WeepingAngle_AIControllerBP.WeepingAngle_AIControllerBP_C.ConfigureAIFromPace
...
// Function WeepingAngle_AIControllerBP.WeepingAngle_AIControllerBP_C.ConfigureAIFromPrediction
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:

void UWeepingAngle_AIControllerBP_C::ConfigureAIFromPrediction()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WeepingAngle_AIControllerBP_C", "ConfigureAIFromPrediction");
...
// Function WeepingAngle_AIControllerBP.WeepingAngle_AIControllerBP_C.ConfigureAIFromHearing
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UBlackboardComponent*        CallFunc_GetBlackboard_ReturnValue                               (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// class FName                        CallFunc_MakeLiteralName_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// Function WeepingAngle_AIControllerBP.WeepingAngle_AIControllerBP_C.ConfigureAIFromSight
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// Function WeepingAngle_AIControllerBP.WeepingAngle_AIControllerBP_C.ConfigureAIFromDamage
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UWeepingAngel_CharacterBP_C* CurrentCloseFriend                                               (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
// TArray<class UWeepingAngel_CharacterBP_C*>CloseFriends                                                     (Edit, BlueprintVisible, DisableEditOnTemplate)
...
// class FName                        CallFunc_MakeLiteralName_ReturnValue_4                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FName                        CallFunc_MakeLiteralName_ReturnValue_5                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UWeepingAngel_CharacterBP_C* CallFunc_Array_Get_Item                                          (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// TArray<class UWeepingAngel_CharacterBP_C*>CallFunc_GetAllActorsOfClass_OutActors                           (ReferenceParm)
// class FName                        CallFunc_MakeLiteralName_ReturnValue_7                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UWeepingAngel_CharacterBP_C* CallFunc_Array_Get_Item_1                                        (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UWeepingAngle_AIControllerBP_C::ConfigureAIFromDamage(class UWeepingAngel_CharacterBP_C* CurrentCloseFriend, const TArray<class UWeepingAngel_CharacterBP_C*>& CloseFriends, int32 Temp_int_Array_Index_Variable, bool CallFunc_SetHearingRange_ReturnValue, class UAIController* CallFunc_GetAIController_ReturnValue, bool CallFunc_SetHearingRange_ReturnValue_1, class UAIController* CallFunc_GetAIController_ReturnValue_1, bool CallFunc_SetSightRange_ReturnValue, bool CallFunc_SetSightRange_ReturnValue_1, class UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue, class UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue_1, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, class UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue_2, const struct FVector& CallFunc_K2_GetRandomReachablePointInRadius_RandomLocation, bool CallFunc_K2_GetRandomReachablePointInRadius_ReturnValue, class UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue_3, class UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue_4, int32 Temp_int_Array_Index_Variable_1, class UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue_5, class FName CallFunc_MakeLiteralName_ReturnValue, class FName CallFunc_MakeLiteralName_ReturnValue_1, class FName CallFunc_MakeLiteralName_ReturnValue_2, class FName CallFunc_MakeLiteralName_ReturnValue_3, class FName CallFunc_MakeLiteralName_ReturnValue_4, class FName CallFunc_MakeLiteralName_ReturnValue_5, class UWeepingAngel_CharacterBP_C* CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, int32 Temp_int_Loop_Counter_Variable, class UPawn* CallFunc_K2_GetPawn_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Loop_Counter_Variable_1, class FName CallFunc_MakeLiteralName_ReturnValue_6, int32 CallFunc_Add_IntInt_ReturnValue_1, TArray<class UWeepingAngel_CharacterBP_C*>& CallFunc_GetAllActorsOfClass_OutActors, class FName CallFunc_MakeLiteralName_ReturnValue_7, class UWeepingAngel_CharacterBP_C* CallFunc_Array_Get_Item_1, int32 CallFunc_Array_Length_ReturnValue_1, int32 CallFunc_Array_Add_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue_1, float CallFunc_GetDistanceTo_ReturnValue, bool CallFunc_LessEqual_DoubleDouble_ReturnValue, class UAIController* CallFunc_GetAIController_ReturnValue_2, class UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue_6, class UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue_7, class UObject* CallFunc_GetValueAsObject_ReturnValue, bool CallFunc_IsValid_ReturnValue, class FName CallFunc_MakeLiteralName_ReturnValue_8, class UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue_8, class FName CallFunc_MakeLiteralName_ReturnValue_9, class UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue_9, class UPawn* CallFunc_K2_GetPawn_ReturnValue_1, class FName CallFunc_MakeLiteralName_ReturnValue_10, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue_1, class UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue_10, const struct FVector& CallFunc_K2_GetRandomReachablePointInRadius_RandomLocation_1, bool CallFunc_K2_GetRandomReachablePointInRadius_ReturnValue_1, class FName CallFunc_MakeLiteralName_ReturnValue_11, class UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue_11, class FName CallFunc_MakeLiteralName_ReturnValue_12, class UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue_12, double CallFunc_LessEqual_DoubleDouble_A_ImplicitCast)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WeepingAngle_AIControllerBP_C", "ConfigureAIFromDamage");

	Params::UWeepingAngle_AIControllerBP_C_ConfigureAIFromDamage_Params Parms{};
...
// Function WeepingAngle_AIControllerBP.WeepingAngle_AIControllerBP_C.ReceivePossess
// (Event, Protected, BlueprintEvent)
// Parameters:
// class UPawn*                       PossessedPawn                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UWeepingAngle_AIControllerBP_C::ReceivePossess(class UPawn* PossessedPawn)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WeepingAngle_AIControllerBP_C", "ReceivePossess");

	Params::UWeepingAngle_AIControllerBP_C_ReceivePossess_Params Parms{};
...
// Function WeepingAngle_AIControllerBP.WeepingAngle_AIControllerBP_C.BndEvt__Soldiers_AIControllerBP_AIPerception_K2Node_ComponentBoundEvent_1_ActorPerceptionUpdatedDelegate__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void UWeepingAngle_AIControllerBP_C::BndEvt__Soldiers_AIControllerBP_AIPerception_K2Node_ComponentBoundEvent_1_ActorPerceptionUpdatedDelegate__DelegateSignature(class UActor* Actor, const struct FAIStimulus& Stimulus)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WeepingAngle_AIControllerBP_C", "BndEvt__Soldiers_AIControllerBP_AIPerception_K2Node_ComponentBoundEvent_1_ActorPerceptionUpdatedDelegate__DelegateSignature");

	Params::UWeepingAngle_AIControllerBP_C_BndEvt__Soldiers_AIControllerBP_AIPerception_K2Node_ComponentBoundEvent_1_ActorPerceptionUpdatedDelegate__DelegateSignature_Params Parms{};
...
// Function WeepingAngle_AIControllerBP.WeepingAngle_AIControllerBP_C.ExecuteUbergraph_WeepingAngle_AIControllerBP
