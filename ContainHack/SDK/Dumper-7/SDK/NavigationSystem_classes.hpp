...
public:
	...
	uint8                                        Pad_1F2A[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1F51[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        BitPad_10A : 2;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1F74[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1FA5[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1FA9[0x27];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1FF0[0x3F];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_20F8[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_20FC[0xDC];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_20FE[0x1323];                                  // Fixing Size Of Struct [ Dumper-7 ]
	...
	enum class ENavigationQueryResult GetPathLength(class UObject* WorldContextObject, struct FVector& PathStart, struct FVector& PathEnd, float* PathLength, class UNavigationData* NavData, TSubclassOf<class UNavigationQueryFilter> FilterClass);
	enum class ENavigationQueryResult GetPathCost(class UObject* WorldContextObject, struct FVector& PathStart, struct FVector& PathEnd, float* PathCost, class UNavigationData* NavData, TSubclassOf<class UNavigationQueryFilter> FilterClass);
...
{
public:
	uint8                                        Pad_2136[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2161[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2173[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2179[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2184[0x3F];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2186[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_218D[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_21AC[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_21D3[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_21DA[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_21EC[0x7F];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_21F8[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_21FC[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
