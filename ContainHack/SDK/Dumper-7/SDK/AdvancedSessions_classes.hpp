...
public:
	...
	void ShowInviteUI(class UPlayerController* PlayerController, enum class EBlueprintResultSwitch* Result);
	void ShowFriendsUI(class UPlayerController* PlayerController, enum class EBlueprintResultSwitch* Result);
...
{
public:
	bool                                         bCallFriendInterfaceEventsOnPlayerControllers;     // 0x1C0(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bCallIdentityInterfaceEventsOnPlayerControllers;   // 0x1C1(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bCallVoiceInterfaceEventsOnPlayerControllers;      // 0x1C2(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bEnableTalkingStatusDelegate;                      // 0x1C3(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_CB4[0x7C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	static class UClass* StaticClass();
	static class UAdvancedFriendsInterface* GetDefaultObj();
...
public:
	...
	void SendSessionInviteToFriends(class UPlayerController* PlayerController, TArray<struct FBPUniqueNetId>& Friends, enum class EBlueprintResultSwitch* Result);
	void SendSessionInviteToFriend(class UPlayerController* PlayerController, struct FBPUniqueNetId& FriendUniqueNetId, enum class EBlueprintResultSwitch* Result);
	void IsAFriend(class UPlayerController* PlayerController, const struct FBPUniqueNetId& UniqueNetId, bool* IsFriend);
	void GetStoredRecentPlayersList(const struct FBPUniqueNetId& UniqueNetId, TArray<struct FBPOnlineRecentPlayer>* PlayersList);
	void GetStoredFriendsList(class UPlayerController* PlayerController, TArray<struct FBPFriendInfo>* FriendsList);
	void GetFriend(class UPlayerController* PlayerController, const struct FBPUniqueNetId& FriendUniqueNetId, struct FBPFriendInfo* Friend);
};

// 0x50 (0x2F8 - 0x2A8)
// Class AdvancedSessions.AdvancedGameSession
class UAdvancedGameSession : public UGameSession
{
public:
	TMap<struct FUniqueNetIdRepl, class FText>   BanList;                                           // 0x2A8(0x50)(Transient, NativeAccessSpecifierPublic)

	static class UClass* StaticClass();
	static class UAdvancedGameSession* GetDefaultObj();
...
public:
	...
	void GetPlayerAuthToken(class UPlayerController* PlayerController, class FString* AuthToken, enum class EBlueprintResultSwitch* Result);
...
public:
	...
	void SetPlayerName(class UPlayerController* PlayerController, const class FString& PlayerName);
	...
	bool KickPlayer(class UObject* WorldContextObject, class UPlayerController* PlayerToKick, class FText KickReason);
	...
	void GetUniqueNetIDFromPlayerState(class UPlayerState* PlayerState, struct FBPUniqueNetId* UniqueNetId);
	void GetUniqueNetID(class UPlayerController* PlayerController, struct FBPUniqueNetId* UniqueNetId);
	...
	void GetPlayerName(class UPlayerController* PlayerController, class FString* PlayerName);
	void GetNumberOfNetworkPlayers(class UObject* WorldContextObject, int32* NumNetPlayers);
	void GetNetPlayerIndex(class UPlayerController* PlayerController, int32* NetPlayerIndex);
	...
	bool BanPlayer(class UObject* WorldContextObject, class UPlayerController* PlayerToBan, class FText BanReason);
...
public:
	FMulticastInlineDelegateProperty_            OnSuccess;                                         // 0x30(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnFailure;                                         // 0x40(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_F6D[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]

	static class UClass* StaticClass();
	static class UCancelFindSessionsCallbackProxy* GetDefaultObj();

	class UCancelFindSessionsCallbackProxy* CancelFindSessions(class UObject* WorldContextObject, class UPlayerController* PlayerController);
};
...
public:
	FMulticastInlineDelegateProperty_            OnSuccess;                                         // 0x30(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnFailure;                                         // 0x40(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_F8D[0x68];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	class UEndSessionCallbackProxy* EndSession(class UObject* WorldContextObject, class UPlayerController* PlayerController);
};
...
public:
	FMulticastInlineDelegateProperty_            OnSuccess;                                         // 0x30(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnFailure;                                         // 0x40(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_FB2[0x48];                                     // Fixing Size Of Struct [ Dumper-7 ]

	static class UClass* StaticClass();
	static class UFindFriendSessionCallbackProxy* GetDefaultObj();

	class UFindFriendSessionCallbackProxy* FindFriendSession(class UObject* WorldContextObject, class UPlayerController* PlayerController, struct FBPUniqueNetId& FriendUniqueNetId);
};
...
public:
	FMulticastInlineDelegateProperty_            OnSuccess;                                         // 0x30(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnFailure;                                         // 0x40(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_FDE[0x80];                                     // Fixing Size Of Struct [ Dumper-7 ]

	static class UClass* StaticClass();
	static class UFindSessionsCallbackProxyAdvanced* GetDefaultObj();

	class UFindSessionsCallbackProxyAdvanced* FindSessionsAdvanced(class UObject* WorldContextObject, class UPlayerController* PlayerController, int32 MaxResults, bool bUseLAN, enum class EBPServerPresenceSearchType ServerTypeToSearch, TArray<struct FSessionsSearchSetting>& Filters, bool bEmptyServersOnly, bool bNonEmptyServersOnly, bool bSecureServersOnly, bool bSearchLobbies, int32 MinSlotsAvailable);
...
public:
	FMulticastInlineDelegateProperty_            OnSuccess;                                         // 0x30(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnFailure;                                         // 0x40(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_FF5[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]

	static class UClass* StaticClass();
	static class UGetFriendsCallbackProxy* GetDefaultObj();

	class UGetFriendsCallbackProxy* GetAndStoreFriendsList(class UObject* WorldContextObject, class UPlayerController* PlayerController);
};
...
public:
	FMulticastInlineDelegateProperty_            OnSuccess;                                         // 0x30(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnFailure;                                         // 0x40(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_FFF[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	FMulticastInlineDelegateProperty_            OnSuccess;                                         // 0x30(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnFailure;                                         // 0x40(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_100F[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	FMulticastInlineDelegateProperty_            OnSuccess;                                         // 0x30(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnFailure;                                         // 0x40(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_1016[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]

	static class UClass* StaticClass();
	static class ULoginUserCallbackProxy* GetDefaultObj();

	class ULoginUserCallbackProxy* LoginUser(class UObject* WorldContextObject, class UPlayerController* PlayerController, const class FString& UserId, const class FString& UserToken, const class FString& AuthType);
};
...
public:
	FMulticastInlineDelegateProperty_            OnSuccess;                                         // 0x30(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnFailure;                                         // 0x40(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_1020[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]

	static class UClass* StaticClass();
	static class ULogoutUserCallbackProxy* GetDefaultObj();

	class ULogoutUserCallbackProxy* LogoutUser(class UObject* WorldContextObject, class UPlayerController* PlayerController);
};
...
public:
	FMulticastInlineDelegateProperty_            OnSuccess;                                         // 0x30(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnFailure;                                         // 0x40(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_102F[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]

	static class UClass* StaticClass();
	static class USendFriendInviteCallbackProxy* GetDefaultObj();

	class USendFriendInviteCallbackProxy* SendFriendInvite(class UObject* WorldContextObject, class UPlayerController* PlayerController, struct FBPUniqueNetId& UniqueNetIDInvited);
};
...
public:
	FMulticastInlineDelegateProperty_            OnSuccess;                                         // 0x30(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnFailure;                                         // 0x40(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_104D[0x48];                                    // Fixing Size Of Struct [ Dumper-7 ]
