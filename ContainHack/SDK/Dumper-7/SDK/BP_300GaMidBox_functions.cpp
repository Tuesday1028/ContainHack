...
class UClass* UBP_300GaMidBox_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_300GaMidBox_C");

	return Clss;
}


// BP_300GaMidBox_C BP_300GaMidBox.Default__BP_300GaMidBox_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_300GaMidBox_C* UBP_300GaMidBox_C::GetDefaultObj()
{
	static class UBP_300GaMidBox_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_300GaMidBox_C*>(UBP_300GaMidBox_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_300GaMidBox.BP_300GaMidBox_C.UserConstructionScript
