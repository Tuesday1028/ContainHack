...
public:
	...
	uint8                                        Pad_AD9[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	struct FOpenColorIODisplayConfiguration      InDisplayConfiguration;                            // 0x0(0x88)(Parm, NativeAccessSpecifierPublic)
	uint8                                        Pad_B0C[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_B0D[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
