...
// BlueprintGeneratedClass BP_5-56GaMidBox.BP_5-56GaMidBox_C
// (Actor)

class UClass* UBP_5Minus56GaMidBox_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_5-56GaMidBox_C");

	return Clss;
}


// BP_5-56GaMidBox_C BP_5-56GaMidBox.Default__BP_5-56GaMidBox_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_5Minus56GaMidBox_C* UBP_5Minus56GaMidBox_C::GetDefaultObj()
{
	static class UBP_5Minus56GaMidBox_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_5Minus56GaMidBox_C*>(UBP_5Minus56GaMidBox_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_5-56GaMidBox.BP_5-56GaMidBox_C.UserConstructionScript
...
void UBP_5Minus56GaMidBox_C::UserConstructionScript(enum class ECollisionEnabled Temp_byte_Variable, enum class ECollisionEnabled Temp_byte_Variable_1, int32 Temp_int_Variable, bool CallFunc_LessEqual_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, bool K2Node_SwitchInteger_CmpSuccess, bool Temp_bool_Variable, int32 Temp_int_Variable_1, double CallFunc_Multiply_IntFloat_ReturnValue, double CallFunc_Multiply_IntFloat_ReturnValue_1, const struct FVector& CallFunc_MakeVector_ReturnValue, double CallFunc_Add_DoubleDouble_ReturnValue, const struct FTransform& CallFunc_MakeTransform_ReturnValue, const struct FVector& CallFunc_MakeVector_ReturnValue_1, int32 CallFunc_AddInstance_ReturnValue, const struct FTransform& CallFunc_MakeTransform_ReturnValue_1, int32 CallFunc_AddInstance_ReturnValue_1, bool CallFunc_LessEqual_IntInt_ReturnValue_1, int32 CallFunc_Add_IntInt_ReturnValue_1, const struct FRotator& CallFunc_MakeRotator_ReturnValue, enum class ECollisionEnabled K2Node_Select_Default, const struct FHitResult& CallFunc_K2_AddRelativeRotation_SweepHitResult, float CallFunc_SetCullDistance_NewCullDistance_ImplicitCast, float CallFunc_SetCullDistance_NewCullDistance_ImplicitCast_1, float CallFunc_MakeRotator_Pitch_ImplicitCast)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_5-56GaMidBox_C", "UserConstructionScript");

	Params::UBP_5Minus56GaMidBox_C_UserConstructionScript_Params Parms{};
