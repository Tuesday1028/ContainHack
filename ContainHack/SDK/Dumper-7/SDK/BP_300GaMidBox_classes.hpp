...
// 0x90 (0x320 - 0x290)
// BlueprintGeneratedClass BP_300GaMidBox.BP_300GaMidBox_C
class UBP_300GaMidBox_C : public UActor
{
public:
	...
	uint8                                        Pad_22FB[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_22FD[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FRandomStream                         Count_ammo_seed;                                   // 0x2F0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor)
	struct FRandomStream                         Height_ammo_Seed;                                  // 0x2F8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor)
	double                                       Space;                                             // 0x300(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	static class UBP_300GaMidBox_C* GetDefaultObj();
