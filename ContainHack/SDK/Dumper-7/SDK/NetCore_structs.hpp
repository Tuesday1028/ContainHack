...
{
public:
	uint8                                        Pad_1B81[0x54];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1B88[0xA8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1B89[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1B8D[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1B98[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1BA0[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1BA5[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
