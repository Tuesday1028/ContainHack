...
public:
	...
	uint8                                        Pad_A60[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B04[0x20];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FRigVMByteCode                        ByteCodeStorage;                                   // 0x60(0x30)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_B05[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_B08[0x38];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_B0A[0xB8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_B0B[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_B24[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_B2A[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
