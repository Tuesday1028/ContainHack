...
class UClass* UTPS_9_mmKovan_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("TPS_9_mmKovan_C");

	return Clss;
}


// TPS_9_mmKovan_C TPS_9_mmKovan.Default__TPS_9_mmKovan_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTPS_9_mmKovan_C* UTPS_9_mmKovan_C::GetDefaultObj()
{
	static class UTPS_9_mmKovan_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTPS_9_mmKovan_C*>(UTPS_9_mmKovan_C::StaticClass()->DefaultObject);

	return Default;
}


// Function TPS_9_mmKovan.TPS_9_mmKovan_C.UserConstructionScript
...
// Function TPS_9_mmKovan.TPS_9_mmKovan_C.ReceiveTick
// (Event, Public, BlueprintEvent)
// Parameters:
// float                              DeltaSeconds                                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UTPS_9_mmKovan_C::ReceiveTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("TPS_9_mmKovan_C", "ReceiveTick");

	Params::UTPS_9_mmKovan_C_ReceiveTick_Params Parms{};
...
// Function TPS_9_mmKovan.TPS_9_mmKovan_C.ExecuteUbergraph_TPS_9_mmKovan
...
void UTPS_9_mmKovan_C::ExecuteUbergraph_TPS_9_mmKovan(int32 EntryPoint, bool Temp_bool_Has_Been_Initd_Variable, bool Temp_bool_IsClosed_Variable, float K2Node_Event_DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("TPS_9_mmKovan_C", "ExecuteUbergraph_TPS_9_mmKovan");

	Params::UTPS_9_mmKovan_C_ExecuteUbergraph_TPS_9_mmKovan_Params Parms{};
