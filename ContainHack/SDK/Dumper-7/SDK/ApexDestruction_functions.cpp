...
class UClass* UDestructibleActor::StaticClass()
{
...
class UDestructibleActor* UDestructibleActor::GetDefaultObj()
{
	static class UDestructibleActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UDestructibleActor*>(UDestructibleActor::StaticClass()->DefaultObject);
