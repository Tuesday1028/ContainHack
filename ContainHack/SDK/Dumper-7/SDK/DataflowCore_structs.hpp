...
{
public:
	uint8                                        Pad_222B[0xC8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_222E[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2233[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
