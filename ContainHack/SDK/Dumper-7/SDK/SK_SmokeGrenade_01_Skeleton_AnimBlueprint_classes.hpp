...
class USK_SmokeGrenade_01_Skeleton_AnimBlueprint_C : public UAnimInstance
{
public:
	uint8                                        Pad_2E4F[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class USK_SmokeGrenade_01_Skeleton_AnimBlueprint_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_SK_SmokeGrenade_01_Skeleton_AnimBlueprint(int32 EntryPoint);
};
