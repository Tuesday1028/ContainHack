...
class USK_StimPack_01_Skeleton_AnimBlueprint_C : public UAnimInstance
{
public:
	...
	static class USK_StimPack_01_Skeleton_AnimBlueprint_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_SK_StimPack_01_Skeleton_AnimBlueprint(int32 EntryPoint);
};
