...
class UGlock19_Gen4_Skeleton_AnimBlueprint_C : public UAnimInstance
{
public:
	uint8                                        Pad_28EB[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0x350(0x8)(ZeroConstructor, Transient, DuplicateTransient)
	struct Glock19_Gen4_Skeleton_AnimBlueprint::FAnimBlueprintGeneratedMutableData    __AnimBlueprintMutables;                           // 0x358(0x4)(HasGetValueTypeHash)
	...
	static class UGlock19_Gen4_Skeleton_AnimBlueprint_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void OnNewFunction(struct FAnimUpdateContext& Context, struct FAnimNodeReference& Node);
	void BlueprintUpdateAnimation(float DeltaTimeX);
	void ExecuteUbergraph_Glock19_Gen4_Skeleton_AnimBlueprint(int32 EntryPoint, float K2Node_Event_DeltaTimeX, class UPawn* CallFunc_TryGetPawnOwner_ReturnValue, class UB_DemoCharacter_C* K2Node_DynamicCast_AsB_Demo_Character, bool K2Node_DynamicCast_bSuccess, class USceneComponent* CallFunc_GetAttachParent_ReturnValue, bool CallFunc_EqualEqual_ObjectObject_ReturnValue);
};
