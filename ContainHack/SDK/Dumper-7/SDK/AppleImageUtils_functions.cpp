...
class UClass* UAppleImageInterface::StaticClass()
{
...
class UAppleImageInterface* UAppleImageInterface::GetDefaultObj()
{
	static class UAppleImageInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<UAppleImageInterface*>(UAppleImageInterface::StaticClass()->DefaultObject);
