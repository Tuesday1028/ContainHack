...
public:
	...
	uint8                                        Pad_81A[0x17];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_823[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
class UMoviePipelineGameMode : public UGameModeBase
{
public:

	static class UClass* StaticClass();
	static class UMoviePipelineGameMode* GetDefaultObj();
...
public:
	...
	uint8                                        Pad_826[0xB];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_82C[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_834[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	class ULevelSequenceActor*                   LevelSequenceActor;                                // 0x80(0x8)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_853[0x288];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_857[0xE0];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_85C[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_960[0x15];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_982[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_989[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_9AC[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_9AD[0x20];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_9B0[0x48];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_9B3[0x1F];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	TSubclassOf<class UGameModeBase>             GameModeOverride;                                  // 0x48(0x8)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_9B6[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_9B7[0xB8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_9BB[0x4F];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_A0D[0xA8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_A75[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_A82[0x48];                                     // Fixing Size Of Struct [ Dumper-7 ]
