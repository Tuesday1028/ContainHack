...
class UALSAIController : public UAIController
{
public:
	...
	static class UALSAIController* GetDefaultObj();
...
class UALSBaseCharacter : public UCharacter
{
public:
	...
	uint8                                        Pad_E2C[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E2E[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E2F[0x29];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	bool                                         bIsPronedAI;                                       // 0x8C1(0x1)(Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_E30[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class UClass* StaticClass();
	static class UALSBaseCharacter* GetDefaultObj();
...
class UALSCharacter : public UALSBaseCharacter
{
public:
	...
	static class UClass* StaticClass();
	static class UALSCharacter* GetDefaultObj();
...
{
public:
	class UALSBaseCharacter*                     Character;                                         // 0x348(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	class UALSBaseCharacter*                     OwnerCharacter;                                    // 0xA0(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_EFB[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<class UALSBaseCharacter*>             AvailableDebugCharacters;                          // 0xB8(0x10)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	class UALSBaseCharacter*                     DebugFocusCharacter;                               // 0xC8(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	void OnPlayerControllerInitialized(class UPlayerController* Controller);
	bool GetShowTraces();
...
public:
	...
	class FName                                  MantleObjectDetectionProfile;                      // 0xF0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	enum class ECollisionChannel                 WalkableSurfaceDetectionChannel;                   // 0xF8(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_F60[0x7];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	struct FALSMantleParams                      MantleParams;                                      // 0x100(0x30)(BlueprintVisible, BlueprintReadOnly, NoDestructor, Protected, NativeAccessSpecifierProtected)
	...
	class UALSBaseCharacter*                     OwnerCharacter;                                    // 0x2C8(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_F67[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
	...
	void MantleEnd();
	bool MantleCheck(struct FALSMantleTraceSettings& TraceSettings, enum class EDrawDebugTrace DebugType);
...
public:
	...
	uint8                                        Pad_FD5[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_FE7[0xE];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
class UALSPlayerCameraManager : public UPlayerCameraManager
{
public:
	class UALSBaseCharacter*                     ControlledCharacter;                               // 0x3340(0x8)(Edit, BlueprintVisible, ZeroConstructor, EditConst, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	static class UClass* StaticClass();
	static class UALSPlayerCameraManager* GetDefaultObj();

	void OnPossess(class UALSBaseCharacter* NewCharacter);
...
class UALSPlayerController : public UPlayerController
{
public:
	class UALSBaseCharacter*                     PossessedCharacter;                                // 0x850(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	static class UClass* StaticClass();
	static class UALSPlayerController* GetDefaultObj();
