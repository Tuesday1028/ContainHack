...
class UClass* UALS_Player_Controller_C::StaticClass()
{
...
class UALS_Player_Controller_C* UALS_Player_Controller_C::GetDefaultObj()
{
	static class UALS_Player_Controller_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UALS_Player_Controller_C*>(UALS_Player_Controller_C::StaticClass()->DefaultObject);
...
void UALS_Player_Controller_C::SetGlobalTimeDilationLocal(double Dilation, bool CallFunc_IsStandalone_ReturnValue, float CallFunc_SetGlobalTimeDilation_TimeDilation_ImplicitCast)
{
	...
	Params::UALS_Player_Controller_C_SetGlobalTimeDilationLocal_Params Parms{};
