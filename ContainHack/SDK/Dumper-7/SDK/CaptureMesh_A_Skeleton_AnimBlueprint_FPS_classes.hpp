...
class UCaptureMesh_A_Skeleton_AnimBlueprint_FPS_C : public UAnimInstance
{
public:
	...
	static class UCaptureMesh_A_Skeleton_AnimBlueprint_FPS_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_CaptureMesh_A_Skeleton_AnimBlueprint_FPS(int32 EntryPoint);
};
