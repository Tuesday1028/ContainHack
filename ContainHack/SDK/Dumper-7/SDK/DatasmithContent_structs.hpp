...
{
public:
	uint8                                        Pad_1189[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	TSoftObjectPtr<class UActor>                 ActorToTrack;                                      // 0x8(0x30)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        BitPad_9C : 2;                                     // Fixing Bit-Field Size  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_11A8[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
