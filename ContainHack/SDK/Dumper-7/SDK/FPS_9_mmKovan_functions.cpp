...
class UClass* UFPS_9_mmKovan_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FPS_9_mmKovan_C");

	return Clss;
}


// FPS_9_mmKovan_C FPS_9_mmKovan.Default__FPS_9_mmKovan_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFPS_9_mmKovan_C* UFPS_9_mmKovan_C::GetDefaultObj()
{
	static class UFPS_9_mmKovan_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFPS_9_mmKovan_C*>(UFPS_9_mmKovan_C::StaticClass()->DefaultObject);
...
void UFPS_9_mmKovan_C::ReceiveTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("FPS_9_mmKovan_C", "ReceiveTick");

	Params::UFPS_9_mmKovan_C_ReceiveTick_Params Parms{};
...
void UFPS_9_mmKovan_C::ExecuteUbergraph_FPS_9_mmKovan(int32 EntryPoint, bool Temp_bool_Has_Been_Initd_Variable, bool Temp_bool_IsClosed_Variable, float K2Node_Event_DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("FPS_9_mmKovan_C", "ExecuteUbergraph_FPS_9_mmKovan");

	Params::UFPS_9_mmKovan_C_ExecuteUbergraph_FPS_9_mmKovan_Params Parms{};
