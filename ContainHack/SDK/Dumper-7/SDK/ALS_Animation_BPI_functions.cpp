...
class UClass* UALS_Animation_BPI_C::StaticClass()
{
...
class UALS_Animation_BPI_C* UALS_Animation_BPI_C::GetDefaultObj()
{
	static class UALS_Animation_BPI_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UALS_Animation_BPI_C*>(UALS_Animation_BPI_C::StaticClass()->DefaultObject);
...
void UALS_Animation_BPI_C::BPI_SetOverlayOverrideState(int32 OverlayOverrideState)
{
	...
	Params::UALS_Animation_BPI_C_BPI_SetOverlayOverrideState_Params Parms{};
...
void UALS_Animation_BPI_C::BPI_SetGroundedEntryState(enum class EGroundedEntryState GroundedEntryState)
{
	static class UFunction* Func = nullptr;
	...
	Params::UALS_Animation_BPI_C_BPI_SetGroundedEntryState_Params Parms{};
