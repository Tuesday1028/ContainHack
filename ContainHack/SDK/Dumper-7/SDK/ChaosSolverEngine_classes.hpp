...
{
public:
	uint8                                        Pad_1A68[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1A70[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1A82[0x110];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1A85[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1AC2[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1AC3[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
